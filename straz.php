...
$title = "Baszta Strażników Miejskich";
$title1 = $title;
...
$arrNames = array('Strażnik Miejski'); 
$objStafflist = $db -> Execute("SELECT `id`, `user`, `rank` FROM `players` WHERE `rank`='Strażnik Miejski'") or die("Błąd!");
