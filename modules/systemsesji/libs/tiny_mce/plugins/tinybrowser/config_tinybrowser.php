...
$tinybrowser['obfuscate'] = 's0mer3D2asdDbF!111';
...
$tinybrowser['path']['image'] = '/pliki/'.$_SESSION['user_hide_id'].'/image/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/pliki/'.$_SESSION['user_hide_id'].'/image/'; // Media files location
$tinybrowser['path']['file']  = '/pliki/'.$_SESSION['user_hide_id'].'/image/'; // Other files location
