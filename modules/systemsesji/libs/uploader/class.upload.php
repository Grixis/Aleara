...
class upload {
    ...
    function init() {
        ...
        $this->file_new_name_body       = 'pcr';       // replace the name body
        $this->file_name_body_add       = $player -> postac['id'];       // append to the name body
        $this->file_new_name_ext        = 'jpg';       // replace the file extension
        ...
        if (!is_array($file)) {
            if (empty($file)) {
                ...
                if ($this->uploaded) {
                    ...
                    $this->image_src_x = $width;
                    $this->image_src_y = $height;
