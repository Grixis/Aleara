{strip}
			...
			<td style="background: url('images/layout/Untitled-1_06.gif') repeat-y top" width="9" height="23">
	...
	<tr>
		...
		<td style="background: url('images/layout/Untitled-1_10.gif') repeat-y top" width="9" height="20">
	...
	<tr>
		...
		<td colspan="2" style="background: url('images/layout/Untitled-1_13.gif') repeat-y top" >
            ...
            {if $Stephead != "new"}
                    <div id="topbar" style="display: online">
	...
	<tr>
		...
		<td colspan="3" style="background: url('images/layout/Untitled-1_03.gif') top" width="36" height="15">
