...
$aRights = array(
    'ban' => array('Admin', 'Staff', 'Karczmarka', 'Ksiądz', 'Ksiadz', 'Prokurator', 'Kapłan', 'Kapłanka Najwyższa', 'Hrabia', 'Namiestnik', 'Hrabia'),
    'unban' => array('Admin', 'Staff', 'Karczmarka', 'Ksiądz', 'Ksiadz', 'Prokurator', 'Kapłan', 'Kapłanka Najwyższa', 'Hrabia', 'Namiestnik', 'Hrabia'),
    'bot' => array('Admin', 'Staff', 'Karczmarka', 'Ksiądz', 'Ksiadz', 'Prokurator', 'Kapłan', 'Kapłanka Najwyższa', 'Hrabia', 'Namiestnik', 'Hrabia'),
    'clear' => array('Admin', 'Staff', 'Karczmarka', 'Ksiądz', 'Ksiadz', 'Prokurator', 'Kapłan', 'Kapłanka Najwyższa', 'Hrabia', 'Namiestnik', 'Hrabia')
);
    ...
    if($_POST['msg'][0] == '!')
    {
        ...
        elseif(preg_match('#^!clear$#', $_POST['msg']))
        {
			...
			if ($room == "'kaplica'")
			{
				...
				$db -> Execute("DELETE FROM chat WHERE room=".$room);
			}
