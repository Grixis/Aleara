...
if($vii == '<font color=green>AKTYWNA</font>')
{
	error ('<center><IMG SRC="przekletajaskinia.png"></center> 
   <img style="margin-left: -8px" width="538px"  src="liniuszka.png"><br><br>
Podnosisz runę, lecz orientujesz się że jest to runa VII którą już ktoś z Twojej drużyny odnalazł. <a href="przekletajaskinia.php">Wracasz...</a>');
}
...
if(isset($_POST['submit']))
{
    switch($_POST['item'])
    {
       case 'credits':
            ...
            $db -> Execute("UPDATE players SET vii=vii+1 WHERE id =".$player -> id);
            $db -> Execute('UPDATE runy SET vii="<font color=green>AKTYWNA</font>"');
            
           
       break;
    }
   
    error('Otrzymałeś runę <b>VII</b><a href="przekletajaskinia.php"> Wracam...</a>');
}

$smarty -> display ('vii.tpl');
