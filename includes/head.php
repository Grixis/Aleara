...
if ($_COOKIE['ban'] == 1)
{
            $smarty -> assign ('Error', "Za złe postępowanie zostałeś skazany na banicję z krainy.");
...
{
$add="<a href='admin.php?view=weather'>[Zmień pogodę]</a>";
}
else
{
$add="";
...
if (isset ($_POST['pass']) )
{
	...
	{
	logIn($_POST['email'], $_POST['pass'], $pllimit, $_POST["finger"]);
    $_SESSION['email'] = $_POST['email'];
    $_SESSION['pass'] = $_POST['pass'];
	}
	else
	{
	logIn($_POST['email'], md5($_POST['pass']), $pllimit, $_POST["finger"]);
    $_SESSION['email'] = $_POST['email'];
...
if (is_file($plik)) 
{ 
$smarty -> assign ('Avatar', '<p><center><img src='.$plik.' style="max-height: 120px;"></p></center>'); 
}
else
{
$smarty -> assign ("Avatar", "<center><img src=\"images/szkielet.jpeg\" height=\"120\" border=\"0\" /></center>"); 
}
...
$smarty -> assign('QLocation', CITY);
        if ($player -> hp > 0)
        {
         ...
         $smarty -> assign(array('Location' => '<li><a href="city.php">Miasto: Aleara</a></li><li><a href="travel.php">Podróż</a></li>',
          'Locationn' => '<a href="city.php" id="przycisk2">  Aleara</a>',
...
$smarty -> assign('QLocation', CITY);
        if ($player -> hp > 0)
        {
         ...
         $smarty -> assign(array('Location' => '<li><a href="city.php">Osada: Krwawe Mokradła</a></li><li><a href="travel.php">Podróż</a></li>',
                                'Locationn' => '<a href="city.php" id="przycisk2">  K. Morkadła</a>',
                                'Hospital' => '<li><a href="hospital.php">'.HOSPITAL.'</a> ['.$healneed.' sz]</li>',
                                'Lbank' => '<li><a href="bank.php">'.BANK.'</a></li>'));
         if ($player -> tribe)
		{
...
$smarty -> assign('QLocation', CITY);
        if ($player -> hp > 0)
        {
         ...
         $smarty -> assign(array('Location' => '<li><a href="diabolium.php">Miasto: Diabolium</a></li>',
                                'Locationn' => '<a href="diabolium.php" id="przycisk2">  Diabolium</a>',
...
$smarty -> assign('QLocation', CITY);
        ...
        'Locationn' => '<a href="wyspazlota.php" id="przycisk2">  W. Złota</a>'));
        if ($player -> tribe)
		{
			$smarty -> assign('Tribe','<ul><li><a href="tribes.php?view=my">Moja Gildia</a></li>
...
$smarty -> assign('QLocation', CITY);
        ...
        'Locationn' => '<a href="wyspamithrilu.php" id="przycisk2">  W. Mithrilu</a>'));
        if ($player -> tribe)
		{
			$smarty -> assign('Tribe','<ul><li><a href="tribes.php?view=my">Moja Gildia</a></li>
    ...
    case 'Góry':
        $smarty -> assign(array('QLocation' => MOUNTAINS,
                                ...
                                'Locationn' => '<a href="gory.php" id="przycisk2">  Góry P.</a>'));
        if ($player -> tribe)
		{
			$smarty -> assign('Tribe','<ul><li><a href="tribes.php?view=my">Moja Gildia</a></li>
    ...
    case 'Las':
        $smarty -> assign(array('QLocation' => FOREST,
                                'Location' => '<li><a href="'.($player -> fight == 0 ? 'las.php' : 'explore.php?akcja=las').'">Las Zbłąkanych Dusz</a></li><li><a href="travel.php">Podróż</a></li>',
                                 'Locationn' => '<a href="las.php" id="przycisk2">  Las Z.D.</a>'));
        if ($player -> tribe)
		{
		$smarty -> assign('Tribe','<ul><li><a href="tribes.php?view=my">Moja Gildia</a></li>
    ...
    case 'Lochy':
        $smarty -> assign(array('QLocation' => JAIL,
                                ...
                                'Locationn' => '<a href="jail.php" id="przycisk2">  Lochy</a>'));
        if ($player -> tribe)
		{
	$smarty -> assign('Tribe','<ul><li><a href="tribes.php?view=my">Moja Gildia</a></li>
    ...
    case 'Portal':
        $smarty -> assign(array('QLocation' => PORTAL,
                                ...
                                'Locationn' => '<a href="portal.php" id="przycisk2">  Portal</a>'));
        break;
    case 'Astralny plan':
...
$smarty->display($test->fields['typszablonu']); 
...
*/
if (($FileName != 'card' && $FileName != 'updates' && $FileName != 'ramyfabuly' && $FileName != 'card2' && $FileName != 'poradnik' && $FileName != 'chat' && $FileName != 'szablon' && $FileName != 'szablon1' && $FileName != 'szablon2' && $FileName != 'szablon3' && $FileName != 'szablon4' && $FileName != 'szablon5' && $FileName != 'szablon22' && $FileName != 'stats' && $FileName != 'view' && $FileName != 'bugtrack' && $FileName != 'admin') && ($player -> race == '' || $player -> clas == '' || $player -> gender == '') && $player -> rank != 'Admin')
    error(UNFINISHED);

//searching a bug logs
if (1) {
	$logFile = fopen('ourlogsdupa.txt','a');
