  ...
  if ($szansa<4)
{
     ...
     if ($roll == 1)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'Pierścień <font color=yellow>&#34;Rotogona&#34;</font> wytrzymałości', 2000,'I',0,0,0,50,0,1,'N',0,0,'N')");
   $db -> Execute("UPDATE players SET rary=rary+1 WHERE id=".$player -> id);
     }

     
     $tekst="<br>Pozbyłeś się przeszkody na swojej drodze oraz zdobywasz tajemniczy przedmiot!";
}
else
{
     $tekst='<br>Pozbyłeś się przeszkody na swojej drodze. Niestety nie zdobyłeś żadnego przedmiotu.';
}
		if ($temp == 0) $strMessage = '<br /><b>'.$fighter -> user.'</b> '.HE_GET.' <b>'.$fighter -> gainexp.'</b> '.EXPERIENCE.' '.ORAZ.' <b>'.$fighter -> gaingold.'</b> '.GOLD_COINS.$tekst.'<br /> <br><a href=kopalniao.php>Przejdz do kolejnego szybu kopalni!</a><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>';
	...
	if ($fighter -> gainexp > 0 && $ucieczka == 0) {
	 ...
	 $db -> Execute("UPDATE players SET rotogony=rotogony+1 WHERE id=".$player -> id);
        $db -> Execute("UPDATE players SET bosszabity=bosszabity+1 WHERE id=".$player -> id);
	}
