  ...
  if ($szansa<2)
{
	 ...
	 if ($roll == 1)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.", '<font color=yellow>&#34;Hetumby&#34;</font>', 200, 'L', 5000, '-200', 1000, 10, 1000, 1, 'N', 0, 200, 'N')") or die ($db->ErrorMsg());
     $db -> Execute("UPDATE players SET rary=rary+1 WHERE id=".$player -> id);
	 }
     if ($roll == 2)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.", '<font color=yellow>&#34;Deregil&#34;</font>', 200, 'B', 500000, '-200', 1000, 10, 1000, 1, 'N', 0, 200, 'N')");
     $db -> Execute("UPDATE players SET rary=rary+1 WHERE id=".$player -> id);   
    } 
      if ($roll == 3)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'<font color=yellow>&#34;Avana&#34;</font>', 200,'W',500000,'-200',1000,10,1000,1,'N',0,200,'N')");
     $db -> Execute("UPDATE players SET rary=rary+1 WHERE id=".$player -> id);
     }
      if ($roll == 4)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'<font color=yellow>&#34;Usurium&#34;</font>', 200,'A',500000,'-200',1000,10,1000,1,'N',0,200,'N')");
    $db -> Execute("UPDATE players SET rary=rary+1 WHERE id=".$player -> id);
     }
      if ($roll == 5)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'<font color=yellow>&#34;Kruxiak&#34;</font>', 200,'H',500000,'-200',1000,10,1000,1,'N',0,200,'N')");
     $db -> Execute("UPDATE players SET rary=rary+1 WHERE id=".$player -> id);
     }
      if ($roll == 6)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'<font color=yellow>&#34;Runusy&#34;</font>', 200,'S',500000,'-200',1000,10,1000,1,'N',0,200,'N')");
   $db -> Execute("UPDATE players SET rary=rary+1 WHERE id=".$player -> id);
     }
       if ($roll == 7)
     {
   ...
   $db -> Execute("UPDATE players SET rary=rary+1 WHERE id=".$player -> id);
      ...
      if ($roll == 8)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'<font color=yellow>&#34;Istrum&#34;</font>', 4,'T',500000,0,0,10,0,1,'N',0,0,'N')");
   $db -> Execute("UPDATE players SET rary=rary+1 WHERE id=".$player -> id);
     }
         if ($roll == 9)
     {
   $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'<font color=yellow>&#34;Sylertusy&#34;</font>', 100,'R',5,0,10000,10,10000,1,'N',0,0,'N')");
   $db -> Execute("UPDATE players SET rary=rary+1 WHERE id=".$player -> id);
     }
...
else
{
     $tekst='';
		...
		if ($temp == 0) $strMessage = '<br /><b>'.$fighter -> user.'</b> '.HE_GET.' <b>'.$fighter -> gainexp.'</b> '.EXPERIENCE.' '.ORAZ.' <b>'.$fighter -> gaingold.'</b> '.GOLD_COINS.$tekst.'<br /> <br><a href=gory.php>Wróć do gór!</a><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>';
...
$db -> Execute("UPDATE players SET nughorgwalki=nughorgwalki+1 WHERE id=".$player -> id);
	...
	if ($title !== 'Arena Walk' && $fighter -> hp == 0) {
        ...
        $db -> Execute("UPDATE players SET nughorgbicie=nughorgbicie+1 WHERE id=".$player -> id);
