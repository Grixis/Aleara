...
$resul1=mysql_query('Select * from players where lpv >='.(time()-180).'  AND id NOT IN(473,475,40,342,353,187,476,477,478,479,15,169,203,236,268,313) AND gametype !="invisible" UNION SELECT * FROM players WHERE id IN(473,475,40,342,353,187,476,477,478,479,15,169,203,236,268,313) AND gametype !="invisible" ORDER by id ASC');
...

{
	...
	$name=getTaggedPlayerName($play['user']);
	...
	print("<div class=\"opis\" style=\"color: grey; display: none\">".$play['opis']."</div>");
	print("</div>");
	...
	if ($play['page'] == 'Altara')
	{
		...
		{
			print('<br><br>Ostatnio widziany: Coweritana');
		}
	}
	else
	{
