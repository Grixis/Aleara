...
function getTaggedPlayerName ($name, $tribeid, $rank)
{
	...
	for ($i = 1; $i <= 10; $i++) {
	 ...
	 $ret = '';
	if ($rankid != -1) {
		$ret =  '<span class=Tag><small><font size="5"><font color="#808080">' . htmlspecialchars($Tribes[$tribeid]['tag_prefix_'.$rankid]) . '</font></font></small></span>';
	}

	return '<span class=Tag><small><font size="5"><font color="#808080">' . htmlspecialchars($Tribes[$tribeid]['tag_sufix']) . '</font></font></small></span>'.$name.$ret;
}
?>
