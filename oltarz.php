...
*/
require_once('languages/'.$player -> lang.'/oltarz.php');
...
*/
    ...
    switch($_GET['view'])
    {
        ...
        case 'prayer':      ///Pray to god.
            ...
            $arrFaithCosts = array(array('2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2', '2'),
			...
			if (isset($_POST['pray']))
			{
				...
				if ($_POST['praytype'] == 0)
				{
					...
					$strQuery = 'UPDATE `players` SET `'.$arrBless[$intNumber].'`=`'.$arrBless[$intNumber].'`+20, ';
					if ($_POST['pray'] == 5 || $_POST['pray'] == 6)
					{
						$strQuery .= '`max_hp`=`max_hp`+20, ';
					}
