...
$log -> Close();
$arrsize2=array_size($arrtext);
$arrsize=number_format($arrsize2/1024,2,'.','');
//print_r($arrtext);
//print($arrsize);
$notesinfo="W notaniku możesz przechowywać różne informacje.<br/>Obecnie masz zajęte<b> ".$arrsize." kB</b> z <b>512 kB</b> dostępnego miejsca na notatki"; 
...
if (isset ($_GET['akcja']) && $_GET['akcja'] == 'dodaj') 
{
    ...
    if (isset ($_GET['step']) && $_GET['step'] == 'send') 
    {
		...
		if ($arrsize2 + strlen($strBody) > 524288)
		{
			error("Nie mogę dodać tego wpisu, gdyż twój notatnik przekroczy dopuszczalną objętość. Skróć tekst lub usuń stare wpisy");
		}
