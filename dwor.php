...
*/
require_once("languages/".$player -> lang."/dwor.php");

if ($player -> level < 7)
    {
        error("Próbowałeś odnaleźć Zaginiony Dwór Krutynów... Jednak nie posiadasz jeszcze informacji o dokładnym jego położeniu... Aby wejść jest wymagany min 7 lvl.");
    }
    ...
    else 
{
    ...
    $gain = (($player -> level*4 + 300) * $_POST['amount']);
