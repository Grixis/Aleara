...
$mod_right = $this->countModules( 'position-7' );        
 ...
 $title2  = $this->params->get("title2", "02.landscape ");		
 $title3  = $this->params->get("title3", "03.gallery ");		
 $title4  = $this->params->get("title4", "04.club events");		 
 $title5  = $this->params->get("title5", "05.latest news");  
 $titlenews  = $this->params->get("titlenews", "HOT NEWS:");
 ?>						 
...
<body>     
    <div id="content">	       
        <div class="pagewidth">	               
            <div id="sitename">				    	             	   				           
                 <a href="index.php"><img src="templates/<?php echo $this->template ?>/images/logo.png" width="564" height="69" alt="logotype" /></a>			            		          
            </div>			               
                    ...
                    <div id="content-top">					                       
                        <div id="topmenu">		                                          
                            ...
                            <div id="content-bottom">						                                  
                                <div id="hightlight-t"><?php echo $titlenews ?></div>							                                          
                                    <div id="hightlight-b">						                                                   
                                        <ul id="news">									                                                               
