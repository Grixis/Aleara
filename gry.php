...
if (isset($_GET['step']) && $_GET['step'] == 'make')
{
    ...
    if (isset($_GET['make']) && $_GET['make'] == 'Y')
    {
        ...
        {
            $intAbility = $intAbility * 8;
            $intGainexp = $intGainexp * 1;
        }
        $intAbility = round($intAbility*100, 0)/100;
        $intAbility = $intAbility ? $intAbility : 0.40; 
...
if (isset($_GET['step']) && $_GET['step'] == 'make2')
{
    ...
    if (isset($_GET['action']) && $_GET['action'] == 'create')
    {
        ...
        if ($intMake > 0)
        {
            ...
            $intGainexp = $objRing -> fields['level'] * 2000;
            $intGainexp = floor($intGainexp * $intAmount2);
            $intAbility = 0.20 * $objRing -> fields['level'] * ($intAmount2 + $intMake);
