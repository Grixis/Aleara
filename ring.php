...
if ($player -> rank != 'Admin' && $player -> rank != 'Staff' && $player -> rank != 'Gladiator')
{
    error ('Nie jesteś dziś gladiatorem!');
}
    ...
    if (isset ($_GET['view']))
    {
        if (!strictInt($_GET['view']))
            ...
            if (is_file($plik))
            {
                ...
                if ($arrImageparams[0] > 300)
                {
                    $arrImageparams[0] = 300;
                }
                if ($arrImageparams[1] > 300)
                {
                    $arrImageparams[1] = 300;
                }
