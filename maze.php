...
print('<center><IMG SRC="images/locations/opuszczonyszyb.png"></center><img style="margin-left: -8px" width="538px"  src="liniuszka.png"><br>');
/**
...
if (isset($_GET['action']) && $_GET['action'] == 'explore')
{
    ...
    if ($intRoll > 48 && $intRoll < 64)
    {
        ...
        if ($inRoll2 < 5 )
        {
        $arrMonsters = array(1000, 1000, 16000, 16000, 22000, 22000, 5000, 5000, 5000);
        $intRoll3 = rand(0, 8);
        }
        if ($intRoll2 == 5)
        {
