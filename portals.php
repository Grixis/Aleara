...
if (isset($_GET['go']) && $_GET['go'] == 'fight')
{
	...
	require_once('class/fight_class.php');
        $arrPower = array(1, 4000, 5500, 6000, 8000, 10000, 20000);
        $arrAgility = array(1, 4000, 5500, 6000, 8000, 10000, 20000);
        $arrSpeed = array(1, 4000, 5500, 6000, 8000, 10000, 20000);
        $arrConstitution = array(1, 4000, 5500, 6000, 8000, 10000, 20000);
        $arrWisdom = array(1, 4000, 5500, 6000, 8000, 10000, 20000);
        $arrInteligence = array(1, 4000, 5500, 6000, 8000, 10000, 20000);
        $arrHitpoints = array(1, 4000, 5500, 6000, 8000, 10000, 20000);
        $arrLevel = array(1, 60, 80, 100, 150, 200, 250);
        $arrExp1 = array(1, 15, 20, 40, 60, 80, 120);
        $arrExp2 = array(1, 15, 20, 40, 60, 80, 120);
