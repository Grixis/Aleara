<?php /* Smarty version 2.6.16, created on 2012-10-07 17:24:53
         compiled from addkroniki.tpl */ ?>
<?php echo '<form method="post" action="';  echo $this->_tpl_vars['Link'];  echo '"><table>';  if ($this->_tpl_vars['Link'] == "addkroniki.php?action=add"):  echo '<tr><td>';  echo $this->_tpl_vars['Ulangsel'];  echo ':</td><td><select name="addlang">';  unset($this->_sections['addupdate']);
