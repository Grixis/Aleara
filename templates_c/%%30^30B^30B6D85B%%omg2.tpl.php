<?php /* Smarty version 2.6.16, created on 2012-10-02 12:42:56
         compiled from omg2.tpl */ ?>
﻿
<?php echo '';  if ($this->_tpl_vars['View'] == "" && $this->_tpl_vars['Read'] == "" && $this->_tpl_vars['Write'] == "" && $this->_tpl_vars['Delete'] == "" && $this->_tpl_vars['Send'] == "" && $this->_tpl_vars['Step'] == "" && $this->_tpl_vars['Block'] == ""):  echo '<p>';  echo @MAIL_INFO;  echo '</p><ul';  if ($this->_tpl_vars['Graphstyle'] == 'Y'):  echo ' class="sword"';  endif;  echo '><li> <a href="omg2.php?view=inbox">Wszystkie Listy</a></li><li> <a href="omg2.php?view=zapis">Zapisane Listy</a></li></ul><br />';  if ($this->_tpl_vars['Senderid']):  echo '<p>';  echo @UNREAD_MAIL;  echo '</p><table width="100%"><tr><td width="25%"><b><u>';  echo @FROM;  echo '</u></b></td><td width="7%"><b><u>';  echo @S_ID;  echo '</u></b></td><td width="48%"><b><u>';  echo @M_TITLE;  echo '</u></b></td><td width="20%"><b><u>';  echo @M_READ;  echo '</u></b></td></tr>';  unset($this->_sections['mail']);
...
$this->_sections['mail']['last']       = ($this->_sections['mail']['iteration'] == $this->_sections['mail']['total']);
 echo '<tr><td><a href="view.php?view=';  echo $this->_tpl_vars['Senderid'][$this->_sections['mail']['index']];  echo '">';  echo $this->_tpl_vars['Sender'][$this->_sections['mail']['index']];  echo '</a></td><td>';  echo $this->_tpl_vars['Senderid'][$this->_sections['mail']['index']];  echo '</td><td>';  echo $this->_tpl_vars['Subject'][$this->_sections['mail']['index']];  echo '</td><td>- <a href="omg2.php?read=';  echo $this->_tpl_vars['Mailid'][$this->_sections['mail']['index']];  echo '&amp;option=c">Czytaj</a><blink> !!</blink><br /></tr>';  endfor; endif;  echo '</table>';  endif;  echo '';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'inbox'):  echo '<form method="post" action="omg2.php?step=mail&amp;box=I"><table width="100%"><tr><td width="5%"></td><td width="20%"><b><u>';  echo @FROM;  echo '</u></b></td><td width="7%"><b><u>';  echo @S_ID;  echo '</u></b></td><td width="48%"><b><u>';  echo @M_TITLE;  echo '</u></b></td><td width="20%"><b><u>';  echo @M_READ;  echo '</u></b></td></tr>';  unset($this->_sections['mail']);
$this->_sections['mail']['name'] = 'mail';
$this->_sections['mail']['loop'] = is_array($_loop=$this->_tpl_vars['Sender']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['mail']['show'] = true;
$this->_sections['mail']['max'] = $this->_sections['mail']['loop'];
...
$this->_sections['mail']['first']      = ($this->_sections['mail']['iteration'] == 1);
$this->_sections['mail']['last']       = ($this->_sections['mail']['iteration'] == $this->_sections['mail']['total']);
 echo '<tr><td><input type="checkbox" name="';  echo $this->_tpl_vars['Mailid'][$this->_sections['mail']['index']];  echo '" /></td><td><a href="view.php?view=';  echo $this->_tpl_vars['Senderid'][$this->_sections['mail']['index']];  echo '">';  echo $this->_tpl_vars['Sender'][$this->_sections['mail']['index']];  echo '</a></td><td>';  echo $this->_tpl_vars['Senderid'][$this->_sections['mail']['index']];  echo '</td><td>';  echo $this->_tpl_vars['Subject'][$this->_sections['mail']['index']];  echo '</td><td>- <a href="omg2.php?read=';  echo $this->_tpl_vars['Mailid'][$this->_sections['mail']['index']];  echo '&amp;option=c">Czytaj</a>';  if ($this->_tpl_vars['Mread'][$this->_sections['mail']['index']] == 'Y'):  echo ' <blink>!!</blink> ';  endif;  echo '<br /></tr>';  endfor; endif;  echo '</table><br /><input type="submit" value="';  echo @A_DELETE_S;  echo '" name="delete" /> <input type="submit" name="write" value="';  echo @A_SAVE_S;  echo '" /> <input type="submit" name="read2" value="';  echo @A_READ2;  echo '" /> <input type="submit" name="unread" value="';  echo @A_UNREAD;  echo '" /><br /></form><form method="post" action="omg2.php?step=deleteold&amp;box=I"><input type="submit" value="';  echo @A_DELETE_OLD;  echo '" /> <select name="oldtime"><option value="7">';  echo @A_WEEK;  echo '</option><option value="14">';  echo @A_2WEEK;  echo '</option><option value="30">';  echo @A_MONTH;  echo '</option></select></form><br />[<a href="omg2.php?view=zapis">';  echo @A_SAVED;  echo '</a>][<a href="omg2.php?view=inbox&amp;step=clear">';  echo @A_CLEAR;  echo '</a>][<a href="omg2.php?view=write">';  echo @A_WRITE;  echo '</a>]';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'zapis'):  echo '<form method="post" action="mail.php?step=mail&amp;box=W"><table width="100%"><tr><td width="5%"></td><td width="20%"><b><u>';  echo @FROM;  echo '</u></b></td><td width="7%"><b><u>';  echo @S_ID;  echo '</u></b></td><td width="48%"><b><u>';  echo @M_TITLE;  echo '</u></b></td><td width="20%"><b><u>';  echo @M_READ;  echo '</u></b></td></tr>';  unset($this->_sections['mail1']);
...
$this->_sections['mail1']['last']       = ($this->_sections['mail1']['iteration'] == $this->_sections['mail1']['total']);
 echo '<tr><td><input type="checkbox" name="';  echo $this->_tpl_vars['Mailid'][$this->_sections['mail1']['index']];  echo '" /></td><td><a href="view.php?view=';  echo $this->_tpl_vars['Senderid'][$this->_sections['mail1']['index']];  echo '">';  echo $this->_tpl_vars['Sender'][$this->_sections['mail1']['index']];  echo '</a></td><td>';  echo $this->_tpl_vars['Senderid'][$this->_sections['mail1']['index']];  echo '</td><td>';  echo $this->_tpl_vars['Subject'][$this->_sections['mail1']['index']];  echo '</td><td>- <a href="omg2.php?read=';  echo $this->_tpl_vars['Mailid'][$this->_sections['mail1']['index']];  echo '&amp;option=c">Czytaj</a><br /></tr>';  endfor; endif;  echo '</table><br /><input type="submit" value="';  echo @A_DELETE_S;  echo '" name="delete" /><br /></form><form method="post" action="omg2.php?step=deleteold&amp;box=W"><input type="submit" value="';  echo @A_DELETE_OLD;  echo '" /> <select name="oldtime"><option value="7">';  echo @A_WEEK;  echo '</option><option value="14">';  echo @A_2WEEK;  echo '</option><option value="30">';  echo @A_MONTH;  echo '</option></select></form><br />[<a href="omg2.php?view=inbox">';  echo @A_INBOX;  echo '</a>][<a href="omg2.php?view=zapis&amp;step=clear">';  echo @A_CLEAR;  echo '</a>][<a href="omg2.php?view=write">';  echo @A_WRITE;  echo '</a>]';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'send'):  echo '<form method="post" action="omg2.php?step=mail&amp;box=S"><table width="100%"><tr><td width="5%"></td><td width="10%"><b><u>';  echo @S_TO;  echo '</u></b></td></td><td width="65%"><b><u>';  echo @M_TITLE;  echo '</u></b></td><td width="20%"></td></tr>';  unset($this->_sections['mail2']);
...
$this->_sections['mail2']['last']       = ($this->_sections['mail2']['iteration'] == $this->_sections['mail2']['total']);
 echo '<tr><td><input type="checkbox" name="';  echo $this->_tpl_vars['Mailid'][$this->_sections['mail2']['index']];  echo '" /></td><td><a href="view.php?view=';  echo $this->_tpl_vars['Send1'][$this->_sections['mail2']['index']];  echo '">';  echo $this->_tpl_vars['Send1'][$this->_sections['mail2']['index']];  echo '</a></td><td>';  echo $this->_tpl_vars['Subject'][$this->_sections['mail2']['index']];  echo '</td><td>- <a href="omg2.php?read=';  echo $this->_tpl_vars['Mailid'][$this->_sections['mail2']['index']];  echo '&amp;option=u">';  echo @M_READ;  echo '</a></td></tr>';  endfor; endif;  echo '</table><br /><input type="submit" value="';  echo @A_DELETE_S;  echo '" name="delete" /> <input type="submit" name="write" value="';  echo @A_SAVE_S;  echo '" /><br /></form><form method="post" action="omg2.php?step=deleteold&amp;box=S"><input type="submit" value="';  echo @A_DELETE_OLD;  echo '" /> <select name="oldtime"><option value="7">';  echo @A_WEEK;  echo '</option><option value="14">';  echo @A_2WEEK;  echo '</option><option value="30">';  echo @A_MONTH;  echo '</option></select></form><br />[<a href="omg2.php">';  echo @A_BACK;  echo '</a>][<a href="omg2.php?view=send&amp;step=clear">';  echo @A_CLEAR;  echo '</a>][<a href="omg2.php?view=write">';  echo @A_WRITE;  echo '</a>]';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'write'):  echo '[<a href="omg2.php?view=inbox">';  echo @A_INBOX;  echo '</a>]<br /><br /><table><form method="post" action="omg2.php?view=write&amp;step=send"><tr><td>';  echo @S_TO;  echo ':</td><td><input type="text" name="to" value="';  echo $this->_tpl_vars['To'];  echo '" /></td></tr><tr><td>';  echo @M_TITLE;  echo ':</td><td><input type="text" name="subject" size="55" value="';  echo $this->_tpl_vars['Reply'];  echo '" /></td></tr><tr><td valign="top">';  echo @M_BODY;  echo ':</td><td><textarea name="body" rows="13" cols="55">';  echo $this->_tpl_vars['Body'];  echo '</textarea></td></tr><tr><td></td><td align="center"><input type="submit" value="';  echo @A_SEND;  echo '" /></td></tr></form></table>';  endif;  echo '';  if ($this->_tpl_vars['Read'] != ""):  echo '<center><span style="font-size: x-large">';  echo $this->_tpl_vars['Subject'];  echo '</span></center><br/><br/><a href="#bottom">Skocz na dół</a><br/><a name="top"> </a>';  unset($this->_sections['mailer']);
...
$this->_sections['mailer']['last']       = ($this->_sections['mailer']['iteration'] == $this->_sections['mailer']['total']);
 echo '<center><table border="1" width="100%"><tr bgcolor="#2F2F2F"><td align="left" border="0" width="50%"> ';  echo $this->_tpl_vars['Sender'][$this->_sections['mailer']['index']];  echo '(';  echo $this->_tpl_vars['Senderid'][$this->_sections['mailer']['index']];  echo ')</td><td align="right" border="0" width="50%"> ';  echo $this->_tpl_vars['Date'][$this->_sections['mailer']['index']];  echo '</td></tr><tr><td colspan="2" align="left">';  echo $this->_tpl_vars['Body'][$this->_sections['mailer']['index']];  echo '<br/></td></tr><tr bgcolor="#2F2F2F"><td colspan="2">[<a href="omg2.php?zapisz=';  echo $this->_tpl_vars['Mailid'][$this->_sections['mailer']['index']];  echo '">';  echo @A_SAVE;  echo '</a>][<a href="omg2.php?kasuj=';  echo $this->_tpl_vars['Mailid'][$this->_sections['mailer']['index']];  echo '">';  echo @A_DELETE;  echo '</a>][<a href="omg2.php?view=write">';  echo @A_WRITE;  echo '</a>][<a href="omg2.php?send=';  echo $this->_tpl_vars['Mailid'][$this->_sections['mailer']['index']];  echo '">';  echo @A_SEND;  echo '</a>][<a href="omg2.php?block=';  echo $this->_tpl_vars['Senderid'][$this->_sections['mailer']['index']];  echo '">';  echo @A_BLOCK;  echo '</a>]</td></tr></table><center><br/><br/>';  endfor; endif;  echo '<a name="bottom"> </a><a href="#top">Skocz na górę</a><br/>[<a href="omg2.php?view=inbox">';  echo @A_INBOX;  echo '</a>]<br /><br />Odpisz:<br/><table><form method="post" action="mail.php?view=write&amp;step=send"><tr><td>Do: ';  echo $this->_tpl_vars['To'];  echo '</td><td><input type="hidden" name="to" value="';  echo $this->_tpl_vars['To'];  echo '" /></td></tr><tr><td>';  echo @M_TITLE;  echo ': ';  echo $this->_tpl_vars['Subject'];  echo '</td><td><input type="hidden" name="subject" size="55" value="';  echo $this->_tpl_vars['Subject'];  echo '" /></td></tr><tr><td valign="top">Tekst:</td><td><textarea name="body" rows="13" cols="55"></textarea></td></tr><tr><td></td><td align="center"><input type="submit" value="Wyślij" /></td></tr></form></table>';  endif;  echo '';  if ($this->_tpl_vars['Send'] != ""):  echo '<form method="post" action="mail.php?send&amp;step=send">';  echo @SEND_THIS;  echo ': <select name="staff">';  unset($this->_sections['mail3']);
