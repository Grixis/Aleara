...
$this->_sections['jeweller']['last']       = ($this->_sections['jeweller']['iteration'] == $this->_sections['jeweller']['total']);
 echo '<tr><td>';  echo $this->_tpl_vars['Rname'][$this->_sections['jeweller']['index']];  echo '</td><td align="center">200</td><td align="center">';  echo $this->_tpl_vars['Ramount'][$this->_sections['jeweller']['index']];  echo '</td><td align="center">200000</td><td align="center"><a href="salerozpaczy2.php?buy=';  echo $this->_tpl_vars['Rid'][$this->_sections['jeweller']['index']];  echo '">';  echo $this->_tpl_vars['Abuy'];  echo '</td></tr>';  endfor; endif;  echo '</table><br /><br />';  echo $this->_tpl_vars['Message'];  echo ''; ?>
</b>