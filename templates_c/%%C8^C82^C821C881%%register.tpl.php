<?php /* Smarty version 2.6.16, created on 2013-02-01 20:07:31
						...
						<tr>
							<td style="width: 315px; height: 150px">	
								<p style="margin-left: 45px; text-align: left">
									...
									<font size="1"><font color="#669999"><br>
...
<form method="post" action="register.php?action=register">   
    ...
    <table border="0" bordercolor="#999999" style=" margin-left: 15px;" cellpadding="2" cellspacing="2" width="120" id="rejestracja_form"> 
										<tr>
											<td>
												<font size="1"><font color="#669999"><font face="Verdana">Nick:
											</td>
									...
									<select name="lang" style=" margin-left: 15px;">
										<?php unset($this->_sections['register']);
$this->_sections['register']['name'] = 'register';
$this->_sections['register']['loop'] = is_array($_loop=$this->_tpl_vars['Lang']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['register']['show'] = true;
...
" class="button"/></div>
  ...
  <br><br><br><br><br><br><br><div id="wiesci">
                  <p style="margin-left: 0px; margin-right: 20px; text-align: left"><br><br>
				          
				          <center><img src="wieesci.png"><br>
				          Jest <b><?php echo $this->_tpl_vars['day']; ?>
</b> dzień <b><?php echo $this->_tpl_vars['age']; ?>
</b> ery.</center><br><br>
				          <b>Najnowsze wieści od władz krainy:</b><br>
				          Team Fabularny Aleary zakończył prace nad fabułą krainy. Został wykreowany bardzo rozbudowany i ciekawie opisany świat. Powstały szczegółowe opisy poszczególnych ziem, księstw, miast, regionów. Zostały określone wymogi co do gry fabularnej. Programiści stworzyli dwie nowe klasy: Artysta oraz Obywatel. Została dodana opcja resetu fabularnego. W krainie została doprowadzona do ładu i składu sprawa profili oraz nicków postaci. System podklas został również zmieniony. Wraz z dniem dzisiejszym (2 listopada 2012r.) ruszyła pierwsza, grupowa sesja fabularna w portalu (menu nawigacji - prywatne - portal) oparta na nowych realiach krainy. Cały opis realiów krainy oraz zasad fabularnych możecie znaleźć w Ramach Fabuły Aleary (menu nawigacji - pozostałe). Wieści fabularne są teraz wyświetlane od razu po zalogowaniu.   </div>
...
<br>
    <br><font size="1"><font color="#669999"><font face="Verdana">Twoja postać została zarejestrowana.<font size="1"><font color="#669999"><font face="Verdana">Możesz już się <a href="index.php"><font size="1"><font color="#669999"><font face="Verdana">ZALOGOWAĆ</font></a>
