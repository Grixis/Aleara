<?php /* Smarty version 2.6.16, created on 2012-12-02 21:34:57
         compiled from admin.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'wordwrap', 'admin.tpl', 148, false),)), $this); ?>
<?php echo '';  if ($this->_tpl_vars['View'] == ""):  echo '<p>';  echo $this->_tpl_vars['Awelcome'];  echo '</p>';  echo '';  unset($this->_sections['i']);
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
 echo '';  if ($this->_sections['i']['last'] && ( $this->_sections['i']['iteration'] % 2 == 1 )):  echo '';  else:  echo '';  endif;  echo '<fieldset><legend><b>';  echo $this->_tpl_vars['Titles'][$this->_sections['i']['index']];  echo '</b></legend>';  unset($this->_sections['j']);
...
$this->_sections['j']['last']       = ($this->_sections['j']['iteration'] == $this->_sections['j']['total']);
 echo '<a href="';  if ($this->_sections['i']['iteration'] != 1 && $this->_sections['i']['iteration'] != 6):  echo 'admin.php?view=';  endif;  echo '';  echo $this->_tpl_vars['Options'][$this->_sections['i']['index']][$this->_sections['j']['index']];  echo '">';  echo $this->_tpl_vars['Descriptions'][$this->_sections['i']['index']][$this->_sections['j']['index']];  echo '</a> <br />';  endfor; endif;  echo '</fieldset>';  if (! $this->_sections['i']['last']):  echo '';  if (! ( $this->_sections['i']['rownum'] % 2 )):  echo '';  endif;  echo '';  else:  echo '';  endif;  echo '';  endfor; endif;  echo '<fieldset><legend><b>Opcje ogólne</b></legend><a href="admin.php?view=pary">Udziel ślubu</a><br><a href="addkroniki.php">Dodaj wpis do kronik</a><br><a href="ip.php">Szukaj multikont</a><br><a href="admin.php?view=weather">Zmień pogodę</a><br><a href="kostuch.php">Otwórz/Zamknij cmentarz nekromantów</a><br><a href="druid.php">Zobacz aktywne kody w wieży druida</a><br><a href="straznik.php?view=changenick">Skasuj avatar graczowi</a><br><a href="murgrabia.php?view=donate">Dotuj gracza brylantami</a><br><a href="murgrabia.php?view=contest">Ogłoś nową turę u murgrabiego</a><br><a href="murgrabia.php?view=prunereps">Wyzeruj punkty reputacji</a><br><a href="panelcheatera.php">Wyślij graczowi wpis do dziennika</a><br><a href="addkroniki.php">Dodaj wpis do kronik głównych</a><br><a href="namiestnik2.php?view=kroniki">Dodaj intro ostatniej kroniki do menu nawigacji</a><br><a href="namiestnik.php?view=newsy">Dodaj intro ostatniego newsa do menu nawigacji</a><br></fieldset>';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'innarchive'):  echo '';  if ($this->_tpl_vars['Text'][0] != ""):  echo '';  unset($this->_sections['player']);
