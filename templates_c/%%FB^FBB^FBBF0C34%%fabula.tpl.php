<?php /* Smarty version 2.6.16, created on 2012-10-06 10:05:58
         compiled from fabula.tpl */ ?>
<?php echo '';  if ($this->_tpl_vars['View'] == "" && $this->_tpl_vars['Step'] == ""):  echo '<center><a href="fabula.php?view=all">Przejdź do czytania kronik naszej krainy</a></center>';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'all' && $this->_tpl_vars['Step'] == ""):  echo '';  unset($this->_sections['upd']);
...
$this->_sections['upd']['last']       = ($this->_sections['upd']['iteration'] == $this->_sections['upd']['total']);
 echo '<div class="overflow"><b>';  echo $this->_tpl_vars['Title1'][$this->_sections['upd']['index']];  echo '</b> ';  echo $this->_tpl_vars['Writeby'];  echo ' <b>';  echo $this->_tpl_vars['Starter'][$this->_sections['upd']['index']];  echo '</b>';  echo $this->_tpl_vars['Date'][$this->_sections['upd']['index']];  echo '... ';  echo $this->_tpl_vars['Modtext'][$this->_sections['upd']['index']];  echo '<br /><br />';  echo $this->_tpl_vars['Update'][$this->_sections['upd']['index']];  echo '</div><a href="fabula.php?step=comments&amp;text=';  echo $this->_tpl_vars['Updid'][$this->_sections['upd']['index']];  echo '">';  echo $this->_tpl_vars['Acomments'];  echo '</a>: ';  echo $this->_tpl_vars['Comments'][$this->_sections['upd']['index']];  echo '<br /><br />';  endfor; endif;  echo '';  endif;  echo '';  if ($this->_tpl_vars['Step'] == 'comments'):  echo '';  if ($this->_tpl_vars['Amount'] == '0'):  echo '<center>';  echo $this->_tpl_vars['Nocomments'];  echo '</center>';  endif;  echo '';  if ($this->_tpl_vars['Amount'] > '0'):  echo '';  unset($this->_sections['update']);
