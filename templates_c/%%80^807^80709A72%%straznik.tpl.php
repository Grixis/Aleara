<?php /* Smarty version 2.6.16, created on 2012-10-06 10:09:37
         compiled from straznik.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'wordwrap', 'straznik.tpl', 104, false),)), $this); ?>
<?php echo '';  if ($this->_tpl_vars['View'] == ""):  echo '<p>';  echo $this->_tpl_vars['Awelcome'];  echo '</p><ul><li><a href="straznik.php?view=poll">Dodaj Ankietę</a></li><br><li><a href="straznik.php?view=czat">Zablokuj/odblokuj wiadomości od gracza na czacie </a></li><br><li><a href="straznik.php?view=banmail">Zablokuj/Odblokuj wiadomości od gracza na poczcie  </a></li><br><li><a href="straznik.php?view=censorship">Dodaj/usuń słowo do listy słów zabronionych    </a></li><br><li><a href="straznik.php?view=jail">Wyślij gracza do więzienia     </a></li><br><li><a href="straznik.php?view=jailbreak">Uwolnij gracza z więzienia     </a></li><br><li><a href="straznik.php?view=changenick">Zmień graczowi imię lub avek     </a></li><br><li><a href="straznik.php?view=poczta">Wyślij wiadomość do wszystkich graczy      </a></li><br></ul><br>';  endif;  echo '<br>';  if ($this->_tpl_vars['View'] == 'addreps'):  echo '<form method="post" action="straznik.php?view=addreps">';  echo @T_PLAYER_ID;  echo ': <input type="text" name="id"><br>';  echo @T_AMOUNT;  echo ': <input type="text" name="amount"><br>';  echo @T_DESC;  echo ': <textarea name="description" cols="30" rows="20"></textarea><br><input type="submit" value="';  echo @A_SEND;  echo '"></form>';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'addtext'):  echo '';  echo $this->_tpl_vars['Admininfo'];  echo '<br />';  echo $this->_tpl_vars['Admininfo2'];  echo '<br />';  echo $this->_tpl_vars['Admininfo3'];  echo '<br />';  echo $this->_tpl_vars['Admininfo4'];  echo '<br /><br />';  echo $this->_tpl_vars['Admininfo5'];  echo ':<table width="100%">';  unset($this->_sections['straznik2']);
$this->_sections['straznik2']['name'] = 'straznik2';
$this->_sections['straznik2']['loop'] = is_array($_loop=$this->_tpl_vars['Ttitle']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['straznik2']['show'] = true;
$this->_sections['straznik2']['max'] = $this->_sections['straznik2']['loop'];
$this->_sections['straznik2']['step'] = 1;
$this->_sections['straznik2']['start'] = $this->_sections['straznik2']['step'] > 0 ? 0 : $this->_sections['straznik2']['loop']-1;
if ($this->_sections['straznik2']['show']) {
    $this->_sections['straznik2']['total'] = $this->_sections['straznik2']['loop'];
    if ($this->_sections['straznik2']['total'] == 0)
        $this->_sections['straznik2']['show'] = false;
} else
    $this->_sections['straznik2']['total'] = 0;
if ($this->_sections['straznik2']['show']):

            for ($this->_sections['straznik2']['index'] = $this->_sections['straznik2']['start'], $this->_sections['straznik2']['iteration'] = 1;
                 $this->_sections['straznik2']['iteration'] <= $this->_sections['straznik2']['total'];
                 $this->_sections['straznik2']['index'] += $this->_sections['straznik2']['step'], $this->_sections['straznik2']['iteration']++):
$this->_sections['straznik2']['rownum'] = $this->_sections['straznik2']['iteration'];
$this->_sections['straznik2']['index_prev'] = $this->_sections['straznik2']['index'] - $this->_sections['straznik2']['step'];
$this->_sections['straznik2']['index_next'] = $this->_sections['straznik2']['index'] + $this->_sections['straznik2']['step'];
$this->_sections['straznik2']['first']      = ($this->_sections['straznik2']['iteration'] == 1);
$this->_sections['straznik2']['last']       = ($this->_sections['straznik2']['iteration'] == $this->_sections['straznik2']['total']);
 echo '<tr><td>';  echo $this->_tpl_vars['Ttitle'][$this->_sections['straznik2']['index']];  echo ' (';  echo $this->_tpl_vars['Tauthor2'];  echo ': ';  echo $this->_tpl_vars['Tauthor'][$this->_sections['straznik2']['index']];  echo ')</td><td><a href="straznik.php?view=addtext&amp;action=modify&amp;text=';  echo $this->_tpl_vars['Tid'][$this->_sections['straznik2']['index']];  echo '">';  echo $this->_tpl_vars['Amodify'];  echo '</a></td><td><a href="straznik.php?view=addtext&amp;action=add&amp;text=';  echo $this->_tpl_vars['Tid'][$this->_sections['straznik2']['index']];  echo '">';  echo $this->_tpl_vars['Aadd'];  echo '</a></td><td><a href="straznik.php?view=addtext&amp;action=delete&amp;text=';  echo $this->_tpl_vars['Tid'][$this->_sections['straznik2']['index']];  echo '">';  echo $this->_tpl_vars['Adelete'];  echo '</a></td></tr>';  endfor; endif;  echo '</table>';  if ($this->_tpl_vars['Action'] == 'modify'):  echo '<form method="post" action="straznik.php?view=addtext&amp;action=modify&amp;text=';  echo $this->_tpl_vars['Tid'];  echo '">';  echo $this->_tpl_vars['Ttitle2'];  echo ': <input type="text" name="ttitle" value="';  echo $this->_tpl_vars['Ttitle'];  echo '" /><br />';  echo $this->_tpl_vars['Tbody2'];  echo ': <br /><textarea name="body" rows="30" cols="60">';  echo $this->_tpl_vars['Tbody'];  echo '</textarea><br /><input type="hidden" name="tid" value="';  echo $this->_tpl_vars['Tid'];  echo '" /><input type="submit" value="';  echo $this->_tpl_vars['Achange'];  echo '" /></form>';  endif;  echo '';  endif;  echo '';  if ($_GET['view'] == 'bugreport'):  echo '';  if ($_GET['step'] != ""):  echo '';  if ($this->_tpl_vars['Bug'][6] == '0'):  echo '<form method="post" action=""><input type="hidden" name="programmer" value=1 /><input type="submit" value="';  echo @BUG_REPAIR;  echo '" /></form>';  echo $this->_tpl_vars['BugMessage'];  echo '';  else:  echo '<form method="post" action=""><input type="hidden" name="programmer" value=0 /><input type="submit" value="';  echo @BUG_LEAVE;  echo '" /></form>';  echo $this->_tpl_vars['BugMessage'];  echo '<p>';  echo @BUG_PROGRAMMER;  echo ' <b>';  echo $this->_tpl_vars['Programmer'];  echo '</b></p>';  endif;  echo '<b>';  echo @BUG_NAME;  echo ':</b> ';  echo $this->_tpl_vars['Bug'][2];  echo '<br /><b>';  echo @BUG_TYPE;  echo ':</b> ';  echo $this->_tpl_vars['BugType'];  echo '<br /><b>';  echo @BUG_LOC;  echo ':</b> ';  echo $this->_tpl_vars['Bug'][4];  echo '<br /><b>';  echo @BUG_DESC;  echo ':</b> ';  echo $this->_tpl_vars['Bug'][5];  echo '<br /><form method="post" action="straznik.php?view=bugreport&amp;step=';  echo $_GET['step'];  echo '"  onsubmit="if (this.bugcomment.value==\'\') ';  echo '{';  echo ' return confirm(\'';  echo @EMPTY_COMMENT;  echo '\') } else ';  echo '{';  echo ' return true; }"><b>';  echo @BUG_ACTIONS;  echo ':</b> <select name="actions">';  unset($this->_sections['k']);
...
$this->_sections['banmail']['last']       = ($this->_sections['banmail']['iteration'] == $this->_sections['banmail']['total']);
 echo 'ID ';  echo $this->_tpl_vars['List1'][$this->_sections['banmail']['index']];  echo '<br />';  endfor; endif;  echo '<form method="post" action="straznik.php?view=banmail&amp;step=mail"><select name="mail"><option value="blok">';  echo $this->_tpl_vars['Ablock'];  echo '</option><option value="odblok">';  echo $this->_tpl_vars['Aunblock'];  echo '</option></select>';  echo $this->_tpl_vars['Mailid'];  echo ' <input type="text" name="mail_id" size="5" /><br /><input type="submit" value="';  echo $this->_tpl_vars['Amake'];  echo '" /></form>';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'playerquest'):  echo '<form method="post" action="straznik.php?view=playerquest&amp;step=add"><input type="submit" value="';  echo $this->_tpl_vars['Aadd'];  echo '" /> ';  echo $this->_tpl_vars['Addplayer'];  echo ' <input type="text" name="pid" size="5" /> ';  echo $this->_tpl_vars['Toquest'];  echo ' <input type="text" name="qid" size="5" />.</form>';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'innarchivef'):  echo '';  if ($this->_tpl_vars['Text'][0] != ""):  echo '';  unset($this->_sections['player']);
...
$this->_sections['forum']['last']       = ($this->_sections['forum']['iteration'] == $this->_sections['forum']['total']);
 echo '<a href="straznik.php?view=forums&amp;id=';  echo $this->_tpl_vars['Catid'][$this->_sections['forum']['index']];  echo '">';  echo $this->_tpl_vars['Catname'][$this->_sections['forum']['index']];  echo '</a><br />';  endfor; endif;  echo '<br /><br /><form method=post action="straznik.php?view=forums&amp;id=';  echo $this->_tpl_vars['Catid2'];  echo '&amp;step=add">';  echo $this->_tpl_vars['Tname'];  echo ': <input type="text" name="catname" value="';  echo $this->_tpl_vars['Tcatname'];  echo '" /><br />';  echo $this->_tpl_vars['Tdesc'];  echo ': <textarea name="catdesc" rows="5" cols="30">';  echo $this->_tpl_vars['Tcatdesc'];  echo '</textarea><br />';  echo $this->_tpl_vars['Tlang'];  echo ': <select name="catlang">';  unset($this->_sections['forum2']);
...
$this->_sections['monster2']['last']       = ($this->_sections['monster2']['iteration'] == $this->_sections['monster2']['total']);
 echo '<option value="';  echo $this->_tpl_vars['Mid'][$this->_sections['monster2']['index']];  echo '">';  echo $this->_tpl_vars['Names'][$this->_sections['monster2']['index']];  echo '</option>';  endfor; endif;  echo '</select><br /><input type="submit" value="';  echo $this->_tpl_vars['Anext'];  echo '" /></form>';  endif;  echo '';  if ($this->_tpl_vars['Step'] == 'next'):  echo '<form method="post" action="straznik.php?view=monster2&amp;step=monster">';  echo $this->_tpl_vars['Tmname'];  echo ': <input type="text" name="name" value="';  echo $this->_tpl_vars['Mname'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmlevel'];  echo ': <input type="text" name="level" value="';  echo $this->_tpl_vars['Mlvl'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmhp'];  echo ': <input type="text" name="hp" value="';  echo $this->_tpl_vars['Mhp'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmagi'];  echo ': <input type="text" name="agility" value="';  echo $this->_tpl_vars['Magility'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmpower'];  echo ': <input type="text" name="strength" value="';  echo $this->_tpl_vars['Mstrength'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmspeed'];  echo ': <input type="text" name="speed" value="';  echo $this->_tpl_vars['Mspeed'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmcond'];  echo ': <input type="text" name="endurance" value="';  echo $this->_tpl_vars['Mendurance'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmmingold'];  echo ': <input type="text" name="credits1" value="';  echo $this->_tpl_vars['Mcredits1'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmmaxgold'];  echo ': <input type="text" name="credits2" value="';  echo $this->_tpl_vars['Mcredits2'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmminexp'];  echo ': <input type="text" name="exp1" value="';  echo $this->_tpl_vars['Mexp1'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmmaxexp'];  echo ': <input type="text" name="exp2" value="';  echo $this->_tpl_vars['Mexp2'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmlocation'];  echo ': <input type="text" name="location" value="';  echo $this->_tpl_vars['Mlocation'];  echo '" /><br /><input type="hidden" name="mid" value="';  echo $this->_tpl_vars['Mid'];  echo '" /><input type="submit" value="';  echo $this->_tpl_vars['Aedit'];  echo '" /></form>';  endif;  echo '';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'jailbreak'):  echo '';  if ($this->_tpl_vars['Step'] == ""):  echo '<form method="post" action="straznik.php?view=jailbreak&amp;step=next"><input type="submit" value="';  echo $this->_tpl_vars['Afree'];  echo '" /> ';  echo $this->_tpl_vars['Jailid'];  echo ' <input type="text" name="jid" size="5" /></form>';  endif;  echo '';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'poll'):  echo '';  if ($this->_tpl_vars['Step'] == ""):  echo '<form method="post" action="straznik.php?view=poll&amp;step=second">';  echo $this->_tpl_vars['Tquestion'];  echo ': <input type="text" name="question" /><br />';  echo $this->_tpl_vars['Tlang'];  echo ': <select name="lang">';  unset($this->_sections['poll2']);
...
$this->_sections['censor']['last']       = ($this->_sections['censor']['iteration'] == $this->_sections['censor']['total']);
 echo '';  echo $this->_tpl_vars['Words'][$this->_sections['censor']['index']];  echo '<br />';  endfor; endif;  echo '';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'register' || $this->_tpl_vars['View'] == 'close'):  echo '<form method="post" action="straznik.php?view=';  echo $this->_tpl_vars['View'];  echo '&amp;step=close"><select name="close"><option value="close">';  echo $this->_tpl_vars['Gclose'];  echo '</option><option value="open">';  echo $this->_tpl_vars['Gopen'];  echo '</option></select><br />';  echo $this->_tpl_vars['Ifclose'];  echo ':<br /><textarea name="reason" rows="13" cols="55"></textarea><br /><input type="submit" value="';  echo $this->_tpl_vars['Amake'];  echo '" /></form>';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'mail'):  echo '<form method="post" action="straznik.php?view=mail&amp;step=send">';  echo $this->_tpl_vars['Mailinfo'];  echo '<br /><textarea name="message"></textarea><br /><input type="submit" value="';  echo $this->_tpl_vars['Asend'];  echo '" /></form>';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'bridge'):  echo '<form method="post" action="straznik.php?view=bridge&amp;step=add">';  echo $this->_tpl_vars['Bquestion'];  echo ': <textarea name="question"></textarea><br />';  echo $this->_tpl_vars['Banswer'];  echo ': <textarea name="answer"></textarea><br /><input type="submit" value="';  echo $this->_tpl_vars['Aadd'];  echo '" /></form>';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'jail'):  echo '';  if (isset ( $this->_tpl_vars['Confirm'] )):  echo '';  echo $this->_tpl_vars['Fquestion'];  echo '<br /><form method="post" action="straznik.php?view=jail&amp;step=add&amp;confirm=Y"><input type="hidden" name="prisoner" value="';  echo $this->_tpl_vars['Prisoner'];  echo '" /><input type="hidden" name="verdict" value="';  echo $this->_tpl_vars['Verdict'];  echo '" /><input type="hidden" name="time"  value="';  echo $this->_tpl_vars['Duration'];  echo '" /><input type="hidden" name="cost"  value="';  echo $this->_tpl_vars['Fine'];  echo '" /><input type="submit" value="';  echo $this->_tpl_vars['Ayes'];  echo '" /></form>';  else:  echo '<form method="post" action="straznik.php?view=jail&amp;step=add">';  echo $this->_tpl_vars['Jailid'];  echo ': <input type="text" name="prisoner" /><br />';  echo $this->_tpl_vars['Jailreason'];  echo ': <textarea name="verdict"></textarea><br />';  echo $this->_tpl_vars['Jailtime'];  echo ': <input type="text" name="time" /><br />';  echo $this->_tpl_vars['Jailcost'];  echo ': <input type="text" name="cost" /><br /><input type="submit" value="';  echo $this->_tpl_vars['Aadd'];  echo '" /></form>';  endif;  echo '';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'add'):  echo '<form method="post" action="straznik.php?view=add&amp;step=add">';  echo $this->_tpl_vars['Addid'];  echo ' <input type="text" name="aid" /> ';  echo $this->_tpl_vars['Newrank'];  echo '<select name="rank"><option value="Member">';  echo $this->_tpl_vars['Rmember'];  echo '</option><option value="Admin">';  echo $this->_tpl_vars['Rking'];  echo '</option><option value="straznik">';  echo $this->_tpl_vars['Rstraznik'];  echo '</option><option value="Sędzia">';  echo $this->_tpl_vars['Rjudge'];  echo '</option><option value="Ławnik">';  echo $this->_tpl_vars['Rjudge2'];  echo '</option><option value="Prawnik">';  echo $this->_tpl_vars['Rlawyer'];  echo '</option><option value="Żebrak">';  echo $this->_tpl_vars['Rbeggar'];  echo '</option><option value="Magazynier">';  echo $this->_tpl_vars['Rbarbarian'];  echo '</option><option value="Bibliotekarz">';  echo $this->_tpl_vars['Rscribe'];  echo '</option><option value="Rycerz">';  echo $this->_tpl_vars['Rknight'];  echo '</option><option value="Dama">';  echo $this->_tpl_vars['Rlady'];  echo '</option><option value="Marszałek Rady">';  echo $this->_tpl_vars['Rcount'];  echo '</option><option value="Poseł">';  echo $this->_tpl_vars['Rcount2'];  echo '</option><option value="Kanclerz Sądu">';  echo $this->_tpl_vars['Rjudge3'];  echo '</option><option value="Redaktor">';  echo $this->_tpl_vars['Rredactor'];  echo '</option><option value="Karczmarka">';  echo $this->_tpl_vars['Rinnkeeper'];  echo '</option><option value="Prokurator">';  echo $this->_tpl_vars['Rprocurator'];  echo '</option><option value="Ksiądz">';  echo $this->_tpl_vars['Rksiadz'];  echo '</option><option value="Magazynier">';  echo $this->_tpl_vars['Rmagazynier'];  echo '</option><option value="Strażnik Miejski">';  echo $this->_tpl_vars['Rstraznik'];  echo '</option><option value="Magazynier">';  echo $this->_tpl_vars['Rmurgrabia'];  echo '</option><option value="Żul spod mostu">';  echo $this->_tpl_vars['Rzul'];  echo '</option><option value="';  echo @RANK_TECH;  echo '">';  echo @RANK_TECH;  echo '</option></select>. <input type="submit" value="';  echo $this->_tpl_vars['Aadd'];  echo '" /></form>';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'equipment'):  echo '<form method="post" action="straznik.php?view=equipment&amp;step=add">';  echo $this->_tpl_vars['Itemname'];  echo ' <input type="text" name="name" /> ';  echo $this->_tpl_vars['Hasa'];  echo '<select name="type" id="type"><option value="W">';  echo $this->_tpl_vars['Iweapon'];  echo '</option><option value="A">';  echo $this->_tpl_vars['Iarmor'];  echo '</option><option value="H">';  echo $this->_tpl_vars['Ihelmet'];  echo '</option><option value="L">';  echo $this->_tpl_vars['Ilegs'];  echo '</option><option value="S">';  echo $this->_tpl_vars['Ishield'];  echo '</option><option value="B">';  echo $this->_tpl_vars['Ibow'];  echo '</option><option value="R">';  echo $this->_tpl_vars['Iarrows'];  echo '</option><option value="T">';  echo $this->_tpl_vars['Istraznik'];  echo '</option><option value="C">';  echo $this->_tpl_vars['Icape'];  echo '</option></select><br /> ';  echo $this->_tpl_vars['Iwith'];  echo '<input name="power" type="number" id="power" /> ';  echo $this->_tpl_vars['Ipower'];  echo '<br />';  echo $this->_tpl_vars['Icost'];  echo ' <input type="number" name="cost" /><br /> ';  echo $this->_tpl_vars['Iminlev'];  echo '<input type="number" name="minlev" /><br /> ';  echo $this->_tpl_vars['Iagi'];  echo '<input name="zr" type="number" /><br /> ';  echo $this->_tpl_vars['Ispeed'];  echo '<input type="number" name="szyb" /><br />';  echo $this->_tpl_vars['Idur'];  echo '<input type="number" name="maxwt" /><br />';  echo $this->_tpl_vars['Irepair'];  echo '<input type="number" name="repair" /><br /><input type="submit" value="';  echo $this->_tpl_vars['Aadd'];  echo '" /></form>';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'donate'):  echo '<form method="post" action="straznik.php?view=donate&amp;step=donated">';  echo $this->_tpl_vars['Donateid'];  echo ': <input type="text" name="id" /> <br />';  unset($this->_sections['res']);
