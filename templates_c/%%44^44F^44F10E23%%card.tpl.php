...
';  echo '<form method="post" action="card.php?action=class&amp;select=obywatel&amp;step=mark"><input type="submit" value="';  echo @C_SELECT;  echo '" /></form></div></div><br />&raquo; <a href="card.php">';  echo @C_BACK;  echo '</a>';  endif;  echo '';  if ($this->_tpl_vars['Action'] == 'deity'):  echo '';  if ($this->_tpl_vars['Select'] == ''):  echo '';  if ($this->_tpl_vars['Step'] == 'change'):  echo '';  if ($this->_tpl_vars['Step2'] == 'confirm'):  echo '';  echo @YOU_CHANGE;  echo ' ';  echo $this->_tpl_vars['Pdeity'];  echo '';  echo @YOU_MAY;  echo ' <a href="card.php?action=deity">';  echo @A_SELECT2;  echo '</a> ';  echo @T_DEITY;  echo '<br />';  else:  echo '';  echo @CHANGE;  echo ' ';  echo $this->_tpl_vars['Ccost'];  echo ' ';  echo @CHANGE2;  echo '<br /><ul';  if ($this->_tpl_vars['Graphstyle'] == 'Y'):  echo ' class="sword"';  endif;  echo '><li><a href="card.php?action=deity&amp;step=change&amp;step2=confirm">';  echo @C_YES;  echo '</a></li><li><a href="card.php">';  echo @C_NO;  echo '</a></li></ul>';  endif;  echo '';  else:  echo '';  endif;  echo '';  else:  echo '<div class="center">';  unset($this->_sections['deity']);
...
$this->_sections['deity']['last']       = ($this->_sections['deity']['iteration'] == $this->_sections['deity']['total']);
 echo '&raquo;<a';  if ($this->_tpl_vars['Select'] == $this->_tpl_vars['GodOption'][$this->_sections['deity']['index']]):  echo ' style="text-decoration: underline"';  endif;  echo ' href="card.php?action=deity&amp;select=';  echo $this->_tpl_vars['GodOption'][$this->_sections['deity']['index']];  echo '">';  echo $this->_tpl_vars['GodName'][$this->_sections['deity']['index']];  echo '</a>&nbsp;';  endfor; endif;  echo '</div>';  echo @C_DEITY_INFO;  echo '<form method="post" action="card.php?action=deity&amp;select=';  echo $this->_tpl_vars['Select'];  echo '&amp;step=mark"><input type="submit" value="';  echo @C_SELECT;  echo '" /></form>';  endif;  echo '<br />&raquo; <a href="card.php">';  echo @C_BACK;  echo '</a><div id="racetabs"><ul><li><a href="card_deity_preview.php?view=azuth">Azuth</a></li><li><a href="card_deity_preview.php?view=lathander">Lathander</a></li><li><a href="card_deity_preview.php?view=tempus">Tempus</a></li><li><a href="card_deity_preview.php?view=loviatar">Loviatar</a></li><li><a href="card_deity_preview.php?view=shar">Shar</a></li><li><a href="card_deity_preview.php?view=kelemvor">Kelemvor</a></li><li><a href="card_deity_preview.php?view=bane">Bane</a></li><li><a href="card_deity_preview.php?view=mielikki">Mielikki</a></li><li><a href="card_deity_preview.php?view=helm">Helm</a></li></ul></div>';  endif;  echo '';  if ($this->_tpl_vars['Action'] == 'place'):  echo '';  if ($this->_tpl_vars['Select'] == ''):  echo '';  echo @C_PLACE;  echo '<ul';  if ($this->_tpl_vars['Graphstyle'] == 'Y'):  echo ' class="sword"';  endif;  echo '>';  echo $this->_tpl_vars['City1'];  echo '';  echo $this->_tpl_vars['City2'];  echo '</ul>';  else:  echo '<div class="center">';  unset($this->_sections['i']);
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
 echo '&raquo;<a';  if ($this->_tpl_vars['Select'] == $this->_tpl_vars['Places'][$this->_sections['i']['index']]):  echo ' style="text-decoration: underline"';  endif;  echo ' href="card.php?action=place&amp;select=';  echo $this->_tpl_vars['Places'][$this->_sections['i']['index']];  echo '">';  echo $this->_tpl_vars['PlacesNames'][$this->_sections['i']['index']];  echo '</a>&nbsp;';  endfor; endif;  echo '</div>';  echo @C_PLACE_INFO;  echo '<form method="post" action="card.php?action=place&amp;select=';  echo $this->_tpl_vars['Select'];  echo '&amp;step=mark"><input type="submit" value="';  echo @C_SELECT;  echo '" /></form>';  endif;  echo '<br />&raquo; <a href="card.php">';  echo @C_BACK;  echo '</a>';  endif;  echo '<br>'; ?>
