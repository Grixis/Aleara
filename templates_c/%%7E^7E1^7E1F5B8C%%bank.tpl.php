<?php /* Smarty version 2.6.16, created on 2013-06-12 16:10:19
         compiled from bank.tpl */ ?>
<?php echo '<center><ul ';  if ($this->_tpl_vars['Graphstyle'] == 'Y'):  echo 'class="sword"';  endif;  echo '><li><a href="bank.php?action=astral&amp;type=p">';  echo $this->_tpl_vars['Aastral'];  echo '</a></li><li><a href="bank.php?action=astral&amp;type=c">';  echo $this->_tpl_vars['Aastral2'];  echo '</a></li>';  echo $this->_tpl_vars['Safebox'];  echo '</center><img style="margin-left: -8px" width="538px"  src="liniuszka.png"><br><br></ul>';  if ($this->_tpl_vars['Action'] != 'astral'):  echo '<fieldset><legend>Wpłać/Wypłać złoto</legend><form method="post" action="bank.php?action=withdraw">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Awithdraw'];  echo '" /> <input id="withdraw" type="text" value="';  echo $this->_tpl_vars['Bank'];  echo '" name="with" /> ';  echo $this->_tpl_vars['Goldcoins'];  echo '<br></form><form method="post" action="bank.php?action=deposit">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Adeposit'];  echo '" /> <input type="text" value="';  echo $this->_tpl_vars['Gold'];  echo '" name="dep" /> ';  echo $this->_tpl_vars['Goldcoins'];  echo '</form><form method="post" action="bank.php?action=donation">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Agive'];  echo '" /> ';  echo $this->_tpl_vars['Dplayer'];  echo ' <input type="text" name="pid" size="3" id="draw" /><input type="text" value="';  echo $this->_tpl_vars['Bank'];  echo '" name="with" /> ';  echo $this->_tpl_vars['Goldcoins'];  echo '</form></fieldset><br><br>';  if ($this->_tpl_vars['Mithril'] > 0):  echo '<fieldset><legend>Przekaż mithril</legend><form method="post" action="bank.php?action=mithril">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Agive'];  echo '" /> ';  echo $this->_tpl_vars['Dplayer'];  echo ' <input type="text" name="pid" size="3" /> <input type="text" name="mithril" value="';  echo $this->_tpl_vars['Mithril'];  echo '" /> ';  echo $this->_tpl_vars['Mamount'];  echo '.</form></fieldset><br><br>';  endif;  echo '<fieldset><legend>Przekaż klucze Diabolium</legend><form method="post" action="bank.php?action=klucz">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Agive'];  echo '" /> ';  echo $this->_tpl_vars['Dplayer'];  echo ' <input type="text" name="pid" size="3" /> <input type="text" name="klucz" value="';  echo $this->_tpl_vars['klucz'];  echo '" /> kluczy.</form></fieldset><br><br><fieldset><legend>Przekaż sadzonki drzewek</legend><form method="post" action="bank.php?action=drzewka">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Agive'];  echo '" /> ';  echo $this->_tpl_vars['Dplayer'];  echo ' <input type="text" name="pid" size="3" /> <input type="text" name="drzewka" value="';  echo $this->_tpl_vars['drzewka'];  echo '" /> sadzonek.</form></fieldset><br><br><fieldset><legend>Przekaż wywar transmutacji</legend><form method="post" action="bank.php?action=wywar">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Agive'];  echo '" /> ';  echo $this->_tpl_vars['Dplayer'];  echo ' <input type="text" name="pid" size="3" /> <input type="text" name="wywar" value="';  echo $this->_tpl_vars['wywar'];  echo '" /> wywarów.</form></fieldset><br><br>';  if ($this->_tpl_vars['Items'] == 1):  echo '<fieldset><legend>Przekaż przedmiot</legend><form method="post" action="bank.php?action=items">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Agive'];  echo '" /> ';  echo $this->_tpl_vars['Dplayer'];  echo ' <input type="text" name="pid" size="3" /><input type="text" name="amount" size="3" /> ';  echo $this->_tpl_vars['Iamount'];  echo ' <select name="item">';  unset($this->_sections['items']);
...
$this->_sections['items']['last']       = ($this->_sections['items']['iteration'] == $this->_sections['items']['total']);
 echo '<option value="';  echo $this->_tpl_vars['Itemid'][$this->_sections['items']['index']];  echo '">(';  echo $this->_tpl_vars['Iamount2'];  echo ': ';  echo $this->_tpl_vars['Itemamount'][$this->_sections['items']['index']];  echo ') ';  echo $this->_tpl_vars['Itemname'][$this->_sections['items']['index']];  echo ' (+';  echo $this->_tpl_vars['Itempower'][$this->_sections['items']['index']];  echo '';  if ($this->_tpl_vars['Itemagi'][$this->_sections['items']['index']] != 0):  echo ' ';  echo $this->_tpl_vars['Iagi'];  echo ' ';  echo $this->_tpl_vars['Itemagi'][$this->_sections['items']['index']];  echo '';  endif;  echo '';  if ($this->_tpl_vars['Itemspeed'][$this->_sections['items']['index']] != 0):  echo ' ';  echo $this->_tpl_vars['Ispe'];  echo ' +';  echo $this->_tpl_vars['Itemspeed'][$this->_sections['items']['index']];  echo '';  endif;  echo ') ';  echo $this->_tpl_vars['Itemwt'][$this->_sections['items']['index']];  echo '/';  echo $this->_tpl_vars['Itemmaxwt'][$this->_sections['items']['index']];  echo '</option>';  endfor; endif;  echo '</select>.</form></fieldset><br><br>';  endif;  echo '';  if ($this->_tpl_vars['Potions'] == 1):  echo '<fieldset><legend>Przekaż mikstury</legend><form method="post" action="bank.php?action=potions">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Agive'];  echo '" /> ';  echo $this->_tpl_vars['Dplayer'];  echo ' <input type="text" name="pid" size="3" /><input type="text" name="amount" size="3" /> ';  echo $this->_tpl_vars['Iamount'];  echo ' <select name="item">';  unset($this->_sections['potion']);
...
$this->_sections['potion']['last']       = ($this->_sections['potion']['iteration'] == $this->_sections['potion']['total']);
 echo '<option value="';  echo $this->_tpl_vars['Potionid'][$this->_sections['potion']['index']];  echo '">(';  echo $this->_tpl_vars['Iamount2'];  echo ': ';  echo $this->_tpl_vars['Potionamount'][$this->_sections['potion']['index']];  echo ') ';  echo $this->_tpl_vars['Potionname'][$this->_sections['potion']['index']];  echo ' (+';  echo $this->_tpl_vars['Potionpower'][$this->_sections['potion']['index']];  echo ')</option>';  endfor; endif;  echo '</select>.</form></fieldset><br><br>';  endif;  echo '';  if ($this->_tpl_vars['Herbs'] == 1):  echo '<fieldset><legend>Przekaż zioła</legend><form method="post" action="bank.php?action=herbs">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Agive'];  echo '" /> ';  echo $this->_tpl_vars['Dplayer'];  echo ' <input type="text" name="pid" size="3" /> <select name="item">';  unset($this->_sections['herb']);
...
$this->_sections['herb']['last']       = ($this->_sections['herb']['iteration'] == $this->_sections['herb']['total']);
 echo '<option value="';  echo $this->_tpl_vars['Herbname'][$this->_sections['herb']['index']];  echo '">';  echo $this->_tpl_vars['Herbname2'][$this->_sections['herb']['index']];  echo '</option>';  endfor; endif;  echo '</select> ';  echo $this->_tpl_vars['Hamount'];  echo ' <input type="text" name="amount" size="5" />.</form></fieldset><br><br>';  endif;  echo '';  if ($this->_tpl_vars['Minerals'] == 1):  echo '<fieldset><legend>Przekaż minerały</legend><form method="post" action="bank.php?action=minerals">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Agive'];  echo '" /> ';  echo $this->_tpl_vars['Dplayer'];  echo ' <input type="text" name="pid" size="3" /> <select name="item">';  unset($this->_sections['mineral']);
...
$this->_sections['mineral']['last']       = ($this->_sections['mineral']['iteration'] == $this->_sections['mineral']['total']);
 echo '<option value="';  echo $this->_tpl_vars['Minoption'][$this->_sections['mineral']['index']];  echo '">';  echo $this->_tpl_vars['Minname'][$this->_sections['mineral']['index']];  echo '</option>';  endfor; endif;  echo '</select> ';  echo $this->_tpl_vars['Hamount'];  echo ' <input type="text" name="amount" size="5" />.</form></fieldset><br><br>';  endif;  echo '<fieldset><legend>Artefakt: żebro</legend><form method="post" action="bankartefaktow.php?action=zebro">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Agive'];  echo '" /> ';  echo $this->_tpl_vars['Dplayer'];  echo ' <input type="text" name="pid" size="3" /> <input type="text" name="zebro" value="';  echo $this->_tpl_vars['zebro'];  echo '" /> artefaktów.</form></fieldset><br><br><fieldset><legend>Artefakt: oko</legend><form method="post" action="bankartefaktow.php?action=oko">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Agive'];  echo '" /> ';  echo $this->_tpl_vars['Dplayer'];  echo ' <input type="text" name="pid" size="3" /> <input type="text" name="oko" value="';  echo $this->_tpl_vars['oko'];  echo '" /> artefaktów.</form></fieldset><br><br><fieldset><legend>Artefakt: włos</legend><form method="post" action="bankartefaktow.php?action=wlos">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Agive'];  echo '" /> ';  echo $this->_tpl_vars['Dplayer'];  echo ' <input type="text" name="pid" size="3" /> <input type="text" name="wlos" value="';  echo $this->_tpl_vars['wlos'];  echo '" /> artefaktów.</form></fieldset><br><br><fieldset><legend>Artefakt: serce</legend><form method="post" action="bankartefaktow.php?action=serce">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Agive'];  echo '" /> ';  echo $this->_tpl_vars['Dplayer'];  echo ' <input type="text" name="pid" size="3" /> <input type="text" name="serce" value="';  echo $this->_tpl_vars['serce'];  echo '" /> artefaktów.</form></fieldset><br><br><fieldset><legend>Artefakt: ząb</legend><form method="post" action="bankartefaktow.php?action=zab">';  echo $this->_tpl_vars['Iwant'];  echo ' <input type="submit" value="';  echo $this->_tpl_vars['Agive'];  echo '" /> ';  echo $this->_tpl_vars['Dplayer'];  echo ' <input type="text" name="pid" size="3" /> <input type="text" name="zab" value="';  echo $this->_tpl_vars['zab'];  echo '" /> artefaktów.</form></fieldset><br><br>';  echo $this->_tpl_vars['Crime'];  echo '';  endif;  echo '';  if ($this->_tpl_vars['Action'] == 'astral'):  echo '<br />';  echo $this->_tpl_vars['Message'];  echo '<br />';  if ($this->_tpl_vars['Type'] == 'p'):  echo '<form method="post" action="bank.php?action=astral&amp;type=p&amp;step=piece">';  echo $this->_tpl_vars['Tsend'];  echo ' <input type="text" name="pid" size="5" /> ';  echo $this->_tpl_vars['Tpiece'];  echo ' <select name="name">';  unset($this->_sections['giveastral']);
...
$this->_sections['astral3']['last']       = ($this->_sections['astral3']['iteration'] == $this->_sections['astral3']['total']);
 echo '<td align="center">';  echo $this->_tpl_vars['Mapsamount'][$this->_sections['astral2']['index']][$this->_sections['astral3']['index']];  echo '</td>';  endfor; endif;  echo '<td colspan="10"></td></tr>';  endfor; endif;  echo '<tr><td colspan="17"><a href="bank.php?action=astral&amp;type=p&amp;give=M">Przekaż wszystkie kawałki map do gildii</a><hr /></td></tr><tr><td width="40%"><b><u>';  echo $this->_tpl_vars['Tname'];  echo '</u></b></td>';  unset($this->_sections['astral']);
$this->_sections['astral']['name'] = 'astral';
...
$this->_sections['astral5']['last']       = ($this->_sections['astral5']['iteration'] == $this->_sections['astral5']['total']);
 echo '<td align="center">';  echo $this->_tpl_vars['Plansamount'][$this->_sections['astral4']['index']][$this->_sections['astral5']['index']];  echo '</td>';  endfor; endif;  echo '</tr>';  endfor; endif;  echo '<tr><td colspan="17"><a href="bank.php?action=astral&amp;type=p&amp;give=P">Przekaż wszystkie kawałki planów do gildii</a><hr /></td></tr><tr><td width="40%"><b><u>';  echo $this->_tpl_vars['Tname'];  echo '</u></b></td>';  unset($this->_sections['astral']);
$this->_sections['astral']['name'] = 'astral';
$this->_sections['astral']['loop'] = is_array($_loop=16) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['astral']['start'] = (int)1;
$this->_sections['astral']['show'] = true;
...
$this->_sections['astral7']['last']       = ($this->_sections['astral7']['iteration'] == $this->_sections['astral7']['total']);
 echo '<td align="center">';  echo $this->_tpl_vars['Recipesamount'][$this->_sections['astral6']['index']][$this->_sections['astral7']['index']];  echo '</td>';  endfor; endif;  echo '</tr>';  endfor; endif;  echo '<tr><td colspan="17"><a href="bank.php?action=astral&amp;type=p&amp;give=R">Przekaż wszystkie kawałki przepisów do gildii</a><hr /></td></tr><tr><td width="40%"><b><u>';  echo $this->_tpl_vars['Tname'];  echo '</u></b></td>';  unset($this->_sections['astral']);
$this->_sections['astral']['name'] = 'astral';
$this->_sections['astral']['loop'] = is_array($_loop=16) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['astral']['start'] = (int)1;
$this->_sections['astral']['show'] = true;
...
$this->_sections['astral102']['last']       = ($this->_sections['astral102']['iteration'] == $this->_sections['astral102']['total']);
 echo '<td align="center">';  echo $this->_tpl_vars['Formulasamount'][$this->_sections['astral101']['index']][$this->_sections['astral102']['index']];  echo '</td>';  endfor; endif;  echo '</tr>';  endfor; endif;  echo '<tr><td colspan="17"><a href="bank.php?action=astral&amp;type=p&amp;give=Y">Przekaż wszystkie kawałki wzorów do gildii</a><hr /></td></tr>';  echo '<tr><td width="40%"><b><u>';  echo $this->_tpl_vars['Tname'];  echo '</u></b></td>';  unset($this->_sections['astral']);
$this->_sections['astral']['name'] = 'astral';
