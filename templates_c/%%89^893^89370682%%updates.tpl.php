<?php /* Smarty version 2.6.16, created on 2012-10-06 15:56:14
         compiled from updates.tpl */ ?>
<?php echo '<center><IMG SRC="images/locations/tablicawiesci.png"></center><img style="margin-left: -8px" width="538px"  src="liniuszka.png"><br><br>Przechodząc błoniami Zamku Królewskiego pomyślałeś, że pójdziesz zobaczyć najnowsze ogłoszenia zawieszone na tablicy wieści przez samego króla. Idziesz spokojnie korzystając z wolnego czasu. Starasz się rozluźnić, wsłuchać w śpiew ptaków i dać się ponieść wyobraźni. Dochodzisz do mrocznego dziedzińca i widzisz już przed sobą wielką marmurową tablicę. Gdy podchodzisz do niej śpiew ptaków umyka w zapomnienie, a mgła staje się gęstsza. Czujesz ogromny przypływ złowrogich mocy. Jednak idziesz dalej, ponieważ ciekawość nie pozwala Ci ani na chwilę dłuższego stania w miejscu. Stajesz w końcu przed ową tablicą i zaczynasz czytać…<br><br>';  if ($this->_tpl_vars['View'] == "" && $this->_tpl_vars['Step'] == ""):  echo '<br><br> ';  echo $this->_tpl_vars['Newplayer'];  echo '<div class="overflow"><b>';  echo $this->_tpl_vars['Title1'];  echo '</b> ';  echo $this->_tpl_vars['Writeby'];  echo ' <b>';  echo $this->_tpl_vars['Starter'];  echo '</b>';  echo $this->_tpl_vars['Date'];  echo '... ';  echo $this->_tpl_vars['Modtext'];  echo '<br /><br />';  echo $this->_tpl_vars['Update'];  echo '</div><a href="updates.php?step=comments&amp;text=';  echo $this->_tpl_vars['Updid'];  echo '">';  echo $this->_tpl_vars['Acomments'];  echo '</a>: ';  echo $this->_tpl_vars['Comments'];  echo '<br /><br />(<a href="updates.php?view=all">';  echo $this->_tpl_vars['Alast10'];  echo '</a>)';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'all' && $this->_tpl_vars['Step'] == ""):  echo '';  unset($this->_sections['upd']);
