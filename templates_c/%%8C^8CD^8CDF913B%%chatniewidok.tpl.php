<?php /* Smarty version 2.6.16, created on 2012-11-14 16:22:31
         compiled from chatniewidok.tpl */ ?>
...
function setResponse(json)
{
      ...
      for(x in json.msg)
      {
        ...
        if(json.msg[x].ownerid != 0 && json.msg[x].sender != \'\')
        {
          ...
          {
           if (last.html() != \'<li id="\'+json.msg[x].id +\'" style="font-weight: bolder;" title="\'+json.msg[x].date+\'">';  echo '';  if ($this->_tpl_vars['Gender'] == 'M'):  echo '';  echo @YOU_TOLD_M;  echo '';  else:  echo '';  echo @YOU_TOLD_F;  echo '';  endif;  echo '';  echo ' <a href="view.php?view=\'+json.msg[x].ownerid+\'" title="">\'+json.msg[x].owner+\'</a>: \'+json.msg[x].text+\'</li>\')
           $(\'<li id="\'+json.msg[x].id +\'" style="font-weight: bolder;" title="\'+json.msg[x].date+\'">';  echo '';  if ($this->_tpl_vars['Gender'] == 'M'):  echo '';  echo @YOU_TOLD_M;  echo '';  else:  echo '';  echo @YOU_TOLD_F;  echo '';  endif;  echo '';  echo ' <a href="view.php?view=\'+json.msg[x].ownerid+\'" title="">\'+json.msg[x].owner+\'</a>: \'+json.msg[x].text+\'</li>\').appendTo("#window");
          }     
          else
          {
...
';  echo '</script><br><center><br><br><a href="http://aleara.boo.pl/admin.php?view=innarchive"><b>ARCHIWUM !!</b></a></center><br><br><center><input type="button" value="URL" onclick="insertURL();" /><input type="button" value="b" onclick="insertTAG(\'<b>\',\'</b>\');" /><input type="button" value="i" onclick="insertTAG(\'<i>\',\'</i>\');" /><input type="button" value="u" onclick="insertTAG(\'<u>\',\'</u>\');" /><input type="button" value="klimat" onclick="insertTAG(\'*\',\'*\');" /><br></center><form name="form" method="post" action="chatmsgs4.php" id="sender"><center><input type="text" name="msg" id="msg" style="width: 500px" /> <input type="submit" value="';  echo @A_SEND;  echo '" style="width: 70px;"/></form></center><div style="width: 100%; height: 400px; margin: auto;"><div id="chat"><div id="window" style="width: 74%;float:left;padding: 0; height: 400px; overflow: auto; border: solid 1px gray;"><noscript>';  echo @E_JS;  echo '</noscript></div><div id="users" style="width: 25%;float:left;padding: 0;border: solid 1px gray;height: 400px; margin: 0px; overflow: auto;"></div></div></div><audio id="sound"><source src="Audio/chat-highlight.ogg"></source></audio><input type="checkbox" id="chkbox" value="playsound"> Wylacz dzwiek wiadomosci'; ?>
