<?php /* Smarty version 2.6.16, created on 2012-10-07 17:18:49
         compiled from murgrabia.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'wordwrap', 'murgrabia.tpl', 100, false),)), $this); ?>
<?php echo '';  if ($this->_tpl_vars['View'] == ""):  echo '<p>';  echo $this->_tpl_vars['Awelcome'];  echo '</p>';  echo '<ul><li><a href="murgrabia.php?view=addreps">Przyznaj punkty reputacji</a></li><li><a href="murgrabia.php?view=donate">Dotuj użytkownika brylantami</a></li><li><a href="murgrabia.php?view=poczta">Roześlij pocztę do wszystkich graczy</a></li><li><a href="murgrabia.php?view=contest">Ogłoś nową turę</a></li><li><a href="murgrabia.php?view=prunereps" onclick="return confirm(\'Na pewno chcesz wyzerować reputację? Ta czynność jest nieodwracalna!\');">Wyzeruj reputację</a></li></ul><br><br><center><fieldset><legend>Info dotyczące bierzącej tury</legend>';  echo $this->_tpl_vars['Turn'];  echo '</fieldset>';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'addreps'):  echo '<form method="post" action="murgrabia.php?view=addreps">';  echo @T_PLAYER_ID;  echo ': <input type="text" name="id"><br>';  echo @T_AMOUNT;  echo ': <input type="text" name="amount"><br>';  echo @T_DESC;  echo ': <textarea name="description" cols="30" rows="20"></textarea><br><input type="submit" value="';  echo @A_SEND;  echo '"></form>';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'addtext'):  echo '';  echo $this->_tpl_vars['Admininfo'];  echo '<br />';  echo $this->_tpl_vars['Admininfo2'];  echo '<br />';  echo $this->_tpl_vars['Admininfo3'];  echo '<br />';  echo $this->_tpl_vars['Admininfo4'];  echo '<br /><br />';  echo $this->_tpl_vars['Admininfo5'];  echo ':<table width="100%">';  unset($this->_sections['staff2']);
...
$this->_sections['banmail']['last']       = ($this->_sections['banmail']['iteration'] == $this->_sections['banmail']['total']);
 echo 'ID ';  echo $this->_tpl_vars['List1'][$this->_sections['banmail']['index']];  echo '<br />';  endfor; endif;  echo '<form method="post" action="murgrabia.php?view=banmail&amp;step=mail"><select name="mail"><option value="blok">';  echo $this->_tpl_vars['Ablock'];  echo '</option><option value="odblok">';  echo $this->_tpl_vars['Aunblock'];  echo '</option></select>';  echo $this->_tpl_vars['Mailid'];  echo ' <input type="text" name="mail_id" size="5" /><br /><input type="submit" value="';  echo $this->_tpl_vars['Amake'];  echo '" /></form>';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'playerquest'):  echo '<form method="post" action="murgrabia.php?view=playerquest&amp;step=add"><input type="submit" value="';  echo $this->_tpl_vars['Aadd'];  echo '" /> ';  echo $this->_tpl_vars['Addplayer'];  echo ' <input type="text" name="pid" size="5" /> ';  echo $this->_tpl_vars['Toquest'];  echo ' <input type="text" name="qid" size="5" />.</form>';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'innarchive'):  echo '';  if ($this->_tpl_vars['Text'][0] != ""):  echo '';  unset($this->_sections['player']);
...
$this->_sections['forum']['last']       = ($this->_sections['forum']['iteration'] == $this->_sections['forum']['total']);
 echo '<a href="murgrabia.php?view=forums&amp;id=';  echo $this->_tpl_vars['Catid'][$this->_sections['forum']['index']];  echo '">';  echo $this->_tpl_vars['Catname'][$this->_sections['forum']['index']];  echo '</a><br />';  endfor; endif;  echo '<br /><br /><form method=post action="murgrabia.php?view=forums&amp;id=';  echo $this->_tpl_vars['Catid2'];  echo '&amp;step=add">';  echo $this->_tpl_vars['Tname'];  echo ': <input type="text" name="catname" value="';  echo $this->_tpl_vars['Tcatname'];  echo '" /><br />';  echo $this->_tpl_vars['Tdesc'];  echo ': <textarea name="catdesc" rows="5" cols="30">';  echo $this->_tpl_vars['Tcatdesc'];  echo '</textarea><br />';  echo $this->_tpl_vars['Tlang'];  echo ': <select name="catlang">';  unset($this->_sections['forum2']);
...
$this->_sections['monster2']['last']       = ($this->_sections['monster2']['iteration'] == $this->_sections['monster2']['total']);
 echo '<option value="';  echo $this->_tpl_vars['Mid'][$this->_sections['monster2']['index']];  echo '">';  echo $this->_tpl_vars['Names'][$this->_sections['monster2']['index']];  echo '</option>';  endfor; endif;  echo '</select><br /><input type="submit" value="';  echo $this->_tpl_vars['Anext'];  echo '" /></form>';  endif;  echo '';  if ($this->_tpl_vars['Step'] == 'next'):  echo '<form method="post" action="murgrabia.php?view=monster2&amp;step=monster">';  echo $this->_tpl_vars['Tmname'];  echo ': <input type="text" name="name" value="';  echo $this->_tpl_vars['Mname'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmlevel'];  echo ': <input type="text" name="level" value="';  echo $this->_tpl_vars['Mlvl'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmhp'];  echo ': <input type="text" name="hp" value="';  echo $this->_tpl_vars['Mhp'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmagi'];  echo ': <input type="text" name="agility" value="';  echo $this->_tpl_vars['Magility'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmpower'];  echo ': <input type="text" name="strength" value="';  echo $this->_tpl_vars['Mstrength'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmspeed'];  echo ': <input type="text" name="speed" value="';  echo $this->_tpl_vars['Mspeed'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmcond'];  echo ': <input type="text" name="endurance" value="';  echo $this->_tpl_vars['Mendurance'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmmingold'];  echo ': <input type="text" name="credits1" value="';  echo $this->_tpl_vars['Mcredits1'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmmaxgold'];  echo ': <input type="text" name="credits2" value="';  echo $this->_tpl_vars['Mcredits2'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmminexp'];  echo ': <input type="text" name="exp1" value="';  echo $this->_tpl_vars['Mexp1'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmmaxexp'];  echo ': <input type="text" name="exp2" value="';  echo $this->_tpl_vars['Mexp2'];  echo '" /> <br />';  echo $this->_tpl_vars['Tmlocation'];  echo ': <input type="text" name="location" value="';  echo $this->_tpl_vars['Mlocation'];  echo '" /><br /><input type="hidden" name="mid" value="';  echo $this->_tpl_vars['Mid'];  echo '" /><input type="submit" value="';  echo $this->_tpl_vars['Aedit'];  echo '" /></form>';  endif;  echo '';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'jailbreak'):  echo '';  if ($this->_tpl_vars['Step'] == ""):  echo '<form method="post" action="murgrabia.php?view=jailbreak&amp;step=next"><input type="submit" value="';  echo $this->_tpl_vars['Afree'];  echo '" /> ';  echo $this->_tpl_vars['Jailid'];  echo ' <input type="text" name="jid" size="5" /></form>';  endif;  echo '';  endif;  echo '';  if ($this->_tpl_vars['View'] == 'poll'):  echo '';  if ($this->_tpl_vars['Step'] == ""):  echo '<form method="post" action="murgrabia.php?view=poll&amp;step=second">';  echo $this->_tpl_vars['Tquestion'];  echo ': <input type="text" name="question" /><br />';  echo $this->_tpl_vars['Tlang'];  echo ': <select name="lang">';  unset($this->_sections['poll2']);
