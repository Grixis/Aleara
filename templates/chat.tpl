...
function setResponse(json)
{
      ...
      for(x in json.msg)
      {
        ...
        if(json.msg[x].ownerid != 0 && json.msg[x].sender != '')
        {
          ...
          {
           if (last.html() != '<li id="'+json.msg[x].id +'" style="font-weight: bolder;" >{/literal}{if $Gender == 'M'}{$smarty.const.YOU_TOLD_M}{else}{$smarty.const.YOU_TOLD_F}{/if}{literal} ['+json.msg[x].date+'] <a href="view.php?view='+json.msg[x].ownerid+'" title="">'+json.msg[x].owner+'</a>: '+json.msg[x].text+'</li>')
           $('<li id="'+json.msg[x].id +'" style="font-weight: bolder;" >{/literal}{if $Gender == 'M'}{$smarty.const.YOU_TOLD_M}{else}{$smarty.const.YOU_TOLD_F}{/if}{literal} ['+json.msg[x].date+'] <a href="view.php?view='+json.msg[x].ownerid+'" title="">'+json.msg[x].owner+'</a>: '+json.msg[x].text+'</li>').appendTo("#window");
          }     
          else
          {
...
<div style="width: 100%; height: 400px; margin: auto;">
 ...
 <form name="form" method="post" action="chatmsgs.php" id="sender">
    WIADOMOSC: <input type="text" name="msg" id="msg" style="width: 400px" />
     <input type="submit"  value="{$smarty.const.A_SEND}" align="right" style="width: 80px;"/><select id="room" name="room">
	
	<option value="piwnica" {if $Room == "piwnica"}selected="selected"{/if}>Piwnica [No-Clima]</option>
	<option value="pokoj1">Pokój [No-Clima]</option>
	
	<option value="piekielko">Karczma Piekiełko [Clima]</option>
	<option value="buzdygan">Karczma Buzdygan [Clima]</option>
  </select><input type="button" value="WWW" onclick="insertURL();" />
...
<input type="button" value="kolor" onclick="insertTAG('<font color=#FF0000><b>','TEKST</b></font>');" />
...
<input type="checkbox" id="chkbox" name="snd" value="playsound" onclick="snd_cookie();"> Wyłącz dzwięk wiadomości
<script type="text/javascript">
set_checkbox();
</script><br>
<li><a href="k1.php">Karczma Piekiełko - informacje</a><br></li>
   <li><a href="k2.php">Karczma Buzdygan - informacje</a><br></li>
