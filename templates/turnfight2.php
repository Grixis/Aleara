  ...
  if ($szansa<99)
{
	 ...
	 if ($roll == 1)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.", '&#34;Sjerony&#34;', 200, 'L', 500000, '-100', 1000, 30, 1000, 1, 'N', 0, 90, 'N')") or die ($db->ErrorMsg());
     
	 }
     if ($roll == 2)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.", '&#34;Insenviv&#34;', 100, 'D', 500000, '-100', 1000, 30, 1000, 1, 'N', 0, 150, 'N')");
     }
      if ($roll == 3)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#174; Kriun siły', 300, 'I', 500000, 0, 0, 30, 0, 1, 'N', 0, 0, 'N')");
     }
      if ($roll == 4)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#174; Kriun siły woli', 300, 'I', 500000, 0, 0, 30, 0, 1, 'N', 0, 0, 'N')");
     }
      if ($roll == 5)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#174; Kriun zręczności', 300, 'I', 500000, 0, 0, 30, 0, 1, 'N', 0, 0, 'N')");
     }
      if ($roll == 6)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#174; Kriun szybkości', 300, 'I', 500000, 0, 0, 30, 0, 1, 'N', 0, 0, 'N')");
     }
      if ($roll == 7)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#174; Kriun wytrzymałości', 300, 'I', 500000, 0, 0, 30, 0, 1, 'N', 0, 0, 'N')");
     }
      if ($roll == 8)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#174; Kriun inteligencji', 300,'I',500000,0,0,30,0,1,'N',0,0,'N')");
     }
      if ($roll == 9)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#34;Krisux&#34;', 150,'W',500000,'-80',1000,30,1000,1,'N',0,50,'N')");
     }
      if ($roll == 10)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#34;Avurt&#34;', 200,'A',500000,'-90',1000,30,1000,1,'N',0,70,'N')");
     }
      if ($roll == 11)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#34;Humar&#34;', 100,'H',500000,'-50',1000,30,1000,1,'N',0,20,'N')");
     }
      if ($roll == 12)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#34;Rytus&#34;', 150,'S',500000,'-100',1000,30,1000,1,'N',0,70,'N')");
     }
      if ($roll == 13)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#34;Nutiduny&#34;', 400,'L',500000,'-300',1000,60,1000,1,'N',0,150,'N')");
     }
     if ($roll == 14)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#34;Szuit&#34;', 200,'D',500000,'-250',1000,60,1000,1,'N',0,200,'N')");
     }
      if ($roll == 15)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#174; Diaburin siły', 500,'I',500000,0,0,60,0,1,'N',0,0,'N')");
     }
      if ($roll == 16)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#174; Diaburin siły woli', 500,'I',500000,0,0,60,0,1,'N',0,0,'N')");
     }
      if ($roll == 17)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#174; Diaburin zręczności', 500,'I',500000,0,0,60,0,1,'N',0,0,'N')");
     }
      if ($roll == 18)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#174; Diaburin szybkości', 500,'I',500000,0,0,60,0,1,'N',0,0,'N')");
     }
      if ($roll == 19)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#174; Diaburin wytrzymałości', 500,'I',500000,0,0,60,0,1,'N',0,0,'N')");
     }
      if ($roll == 20)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#174; Diaburin inteligencji', 500,'I',500000,0,0,60,0,1,'N',0,0,'N')");
     }
      if ($roll == 21)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#34;Bioluh&#34;', 300,'W',500000,'-250',1000,60,1000,1,'N',0,150,'N')");
     }
      if ($roll == 22)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#34;Durizjum&#34;', 500,'A',500000,'-220',1000,60,1000,1,'N',0,120,'N')");;
     }
      if ($roll == 23)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#34;Hunajan&#34;', 300, 'H', 500000, '-210', 1000, 60, 1000, 1, 'N', 0, 150, 'N')");
     }
      if ($roll == 24)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#34;Claritun&#34;', 400,'S',500000,'-150',1000,60,1000,1,'N',0,170,'N')");
     }
     
       if ($roll == 25)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#34;Opiena&#34;', 200,'C',500000,0,1000,30,1000,1,'N',0,0,'N')");
     }
        if ($roll == 26)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#34;Siumba&#34;', 300,'C',500000,0,1000,60,1000,1,'N',0,0,'N')");
     }
     
     
      if ($roll == 27)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#34;Zunia&#34;', 150,'T',500000,0,1000,30,1000,1,'N',0,0,'N')");
     }
        if ($roll == 28)
     {
          $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand) VALUES(".$player -> id.",'&#34;Munda&#34;', 200,'T',500000,0,1000,60,1000,1,'N',0,0,'N')");
     }
     
      

     
     $tekst=" oraz zdobywa tajemniczy przedmiot!";
}
else
{
     $tekst='';
}
		if ($temp == 0) $strMessage = '<br /><b>'.$fighter -> user.'</b> '.HE_GET.' <b>'.$fighter -> gainexp.'</b> '.EXPERIENCE.' '.ORAZ.' <b>'.$fighter -> gaingold.'</b> '.GOLD_COINS.$tekst.'<br /> <br><a href=diabolium.php>Wróć do miasta!</a><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>';
