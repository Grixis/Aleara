...
if ($player -> location == 'Altara') {
	...
	array('Arena Walk', 'Trening', 'Lochy', 'Królewski Skład', 'Pośredniak'),
	...
	array('Stajnia', 'Tablica Ogłoszeń', 'Pobliskie Targowisko', 'Wieża Druida'),
	array('Strażnica', 'Farma', 'Polana Chowańców', 'Tartak', 'Cech')
	);
