...
{/literal}
<div class="center" style="width=560px;height:560px;overflow:auto"><img id="mapa" src="images/mapa.jpg" useMap="#map_small" border="0" onclick="changemap()" alt="img_map" /></div>
