...
if($test -> fields['klucz'] == '0')
{
    error ('<center><IMG SRC="images/locations/bramymiasta.png"></center><Br>Nie posiadasz klucza do wrót miasta!');
}

if (isset ($_GET['akcja']) && $_GET['akcja'] == 'zm') {
 if($test -> fields['klucz'] == '0') error('<center><IMG SRC="images/locations/bramymiasta.png"></center><Br>Nie posiadasz klucza do wrót miasta!');
    ...
    error ('<center><IMG SRC="images/locations/bramymiasta.png"></center><Br>Dotarłeś pod bramę Diabolium. Wejdź <a href=diabolium.php>tutaj</a> aby zobaczyć czy masz wstęp do miasta.');
    }

	
if (isset ($_GET['akcja']) && $_GET['akcja'] == 'powrot') {
    if ($player -> credits < 5000) {
     error ('<center><IMG SRC="images/locations/bramymiasta.png"></center><Br>Nie masz tyle pieniędzy!');
    }
    ...
    if (!$fight -> fields['fight']) {
        ...
        error ('<center><IMG SRC="images/locations/bramymiasta.png"></center><Br>Dotarłeś do Aleary. Wejdź <a href=city.php>tutaj</a> aby zobaczyć co ciebie czeka.');
    }
}
