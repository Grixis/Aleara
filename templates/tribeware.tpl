...
{if $Step == "zobacz"}
    ...
    <table width="100%">
    <tr>
    <td width="50%"><a href="tribeware.php?step=zobacz&amp;lista=name"><b><u>{$Tname}</u></b></a></td>
    <td width="30%"><a href="tribeware.php?step=zobacz&amp;lista=efect"><b><u>{$Tefect}</u></b></a></td>
    <td width="10%"><b><u>{$Tamount2}</u></b></td>
