...
if ($lekarz < 2) {
error ('<center><IMG SRC="images/locations/gmachgildii.png">Twoja gildia nie ma wybudowanego szpitala! <br><br><a href="tribes.php?view=my">(Wróć)</a></center>');
}
if ($godziny < 1) {
error ('<center><IMG SRC="images/locations/gmachgildii.png">Twoja gildia nie opłaciła lekarza! <br><br><a href="tribes.php?view=my">(Wróć)</a></center>');
}
if ($player -> hp > $player -> max_hp - 1) {
error ('<center><IMG SRC="images/locations/gmachgildii.png">Nie potrzebujesz leczenia! <br><br><a href="tribes.php?view=my">(Wróć)</a></center>');
}
