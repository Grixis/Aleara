...
{if $View == "market"}
    ...
    <table width="100%">
    <tr>
    <td width="33%"><a href="mmarket.php?view=market&amp;lista=name&amp;limit=0"><b><u>{$Tname}</u></b></a></td>
    <td width="13%" align="center"><a href="mmarket.php?view=market&amp;lista=efect&amp;limit=0"><b><u>{$Tefect}</u></b></a></td>
    <td width="8%"><a href="mmarket.php?view=market&amp;lista=amount&amp;limit=0"><b><u>{$Tamount}</u></b></a></td>
    <td width="8%"><a href="mmarket.php?view=market&amp;lista=cost&amp;limit=0"><b><u>{$Tcost}</u></b></a></td>
    <td width="20%"><a href="mmarket.php?view=market&amp;lista=owner&amp;limit=0"><b><u>{$Tseller}</u></b></a></td>
...
{if $View == "all"}
    ...
    <table width="70%">
    <tr>
    <td width="60%"><b><u>{$Pname}</u></b></td><td width="20%"><b><u>{$Pamount}</u></b></td><td width="20%" align="center"><b><u>{$Paction}</u></b></td>
    </tr>
    {section name=all loop=$Name}
        <tr>
        <td>{$Name[all]}</td>
    <td align="center">{$Amount[all]}</td>
    <td align="center"><form method="post" action="mmarket.php?view=market&amp;limit=0&amp;lista=id">
