...
{if $View == "weather"}
    ...
    {/section} 
	Dodaj nowy wpis:<br>
	<form method="post" action="admin.php?view=weather&amp;step=add">
	Treść:<br>
...
{if $View == "newsy"}
	...
	Dodaj nowy wpis:<br>
	<form method="post" action="admin.php?view=newsy&amp;step=add">
	Treść:<br>
	<textarea name="text"></textarea>
	<INPUT type="submit" value="Wyślij">
	</form>
...
{if $View == "kroniki"}
	...
	Dodaj nowy wpis:<br>
	<form method="post" action="admin.php?view=kroniki&amp;step=add">
	Treść:<br>
	<textarea name="text"></textarea>
	<INPUT type="submit" value="Wyślij">
	</form>
