...
<div style="width: 100%; height: 400px; margin: auto;">
  ...
  <select id="room" name="room">
	...
	<option value="piwnica">{$piwnica}</option>
	<option value="piwnica" {if $Room == "piwnica"}selected="selected"{/if}>piwnica</option>
  </select>
   <br><br>
   <li><a href="regulaminkarczmy.php"><font color="red"><b>REGULAMIN KARCZMY!</b></font></a></li>
...
{if $View == "avatar"}
  ...
  <center><br /><br /><img alt="img_avatar" src="{$Avatar}" width="100" heigth="100">
   <form action="account.php?view=avatar&amptep=usun" method="post">
  <input type="hidden" name="av" value="{$Value}" />
  <input type="submit" value="{$Delete}" /></form></center>
  {/if}
  <form enctype="multipart/form-data" action="account.php?view=avatar&amptep=dodaj" method="post">
