...
{if $Step == "" && $Read == "" && $Comments == "" && $Step3 == ""}
  ...
  Rozgl¹daj¹c siê po Wielkim Zamku Twój wzrok przyci¹gnê³y stare, uchylone drzwi. Podchodz¹c bli¿ej dostrzeg³eœ wielk¹ salê sk¹pan¹ w promieniach s³onecznych przedostaj¹cych siê przez sporej wielkoœci okna. W owej sali znajdowa³y siê rzêdy biurek na których piêtrzy³y siê stosy wycinków z gazet i najnowszych plotek. W tym ma³ym chaosie mo¿na by³o ostrzec jednak ³ad i porz¹dek. Okaza³o siê jednak, ¿e nie jesteœ tam sam, m³oda dziewczyna zobaczywszy Ciê obdarowa³a Ciê promiennym uœmiechem i spyta³a czy nie zechcia³byœ przeczytaæ  najnowszego wydania Gazety Aleariañskiej. A mo¿e chcia³byœ pomóc w redagowaniu i napisaæ coœ do tej w³aœnie gazety?
  
  <br><br>

		<ul {if $Graphstyle=="Y"}class="sword"{/if}>
		<center><IMG SRC="images/locations/newspaper.png"></center>
		<img style="margin-left: -8px" width="538px"  src="liniuszka.png"><br><br>
                ...
                {if $Rank == "Admin" || $Rank == "Redaktor"}
                    <li><a href="newspaper.php?step=redaction">Redakcja gazety</a></li>
                {/if}
		</ul>
{/if}
