...
{if $Step == ""}
    Wędrując ulicami miasta spostrzegasz bogato zdobiony szyld. Wielki pierścień błyszczał już z wielu metrów. Podchodząc bliżej spostrzegasz, że za dużym oknem wystawowym znajdują się formy do odlewów, schematy i wiele innych rzeczy potrzebnych do wyrobu biżuterii. Gnom siedzący w środku zauważył Cię i skinął na Ciebie palcem. 
<br>
Po wejściu do środka słyszysz: <br>
- Widzę zainteresowanie w Twoich oczach. Może chcesz kupić jakiś plan pierścienia? Z warsztatu oczywiście możesz skorzystać za darmo. Chcesz coś zrobić?<br /><br />
