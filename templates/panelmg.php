...
if ($player -> rank != 'Admin' && $player -> rank != 'Mistrz Gry' && $player -> rank != 'Mistrzyni Gry')
{
...
if (isset($_GET['view']) && $_GET['view'] == 'playerquest')
{
    ...
    if (isset($_GET['step']) && $_GET['step'] == 'add')
    {
        ...
        $db -> Execute("UPDATE `players` SET `forumfab`=".$_POST['pid']." WHERE id=".$_POST['pid']);
...
if (isset ($_GET['view']) && $_GET['view'] == 'donate2')
{
	$resources = array ('pktfabularne');
