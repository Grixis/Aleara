...
<p><b>Imię</b> postaci musi składać się z co najmniej 3 znaków przy czym każdy wyraz musi zaczynać się z wielkiej litery. </p>
<p>Mamy obecnie ');
    define('DESCRIPTION2', '<p>Przed Tobą znajdują się Wrota Aleary – magiczny portal, który przeniesie Cię w świat magii i miecza, w którym rządzą inne prawa natury, gdzie czuć namacalny wpływ bóstw często wpływających na życie mieszkańców Aleary i Coveritany.</p>
<p>Widzisz uzbrojonych strażników pilnujących wejścia do portalu. Gdy już przekroczysz jego próg, nie będzie odwrotu . Pamiętaj – to od Twoich czynów będzie zależeć jaka drogą będziesz podążał. Masz możliwość zostać sławnym magiem, wojownikiem, rzemieślnikiem czy złodziejem, a jeśli Twoje czyny będą godne miana bohatera, zostaniesz na trwałe zapisany w Kronikach Krainy.</p>');
    ...
    define('RULE5', 'Jeżeli nie zgadzasz się z karą, możesz zawsze decyzję zaskarżyć do Sądu Najwyższego Krainy - jego siedziba znajduje się na forum zewnętrznym (link podany jest u góry).');
