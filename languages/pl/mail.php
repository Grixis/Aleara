...
define('A_INBOX', 'Chcę przejrzeć moje listy.');
define('A_WRITE', 'Chcę napisać list do kogoś.');
...
{
    define('MAIL_INFO', 'Znajdujesz się na poczcie. Co chcesz zrobić?');
    define('A_SAVED', 'Chcę zobaczyć zachowane listy.');
    define('A_OUTBOX', 'Wysłane');
    define('A_BLOCK_LIST', 'Chcę zobaczyć listę zablokowanych nadawców.');
}
