<center>
<param name="movie" value="city34.swf">
<param name="menu" value=false>
<param name="loop" value=true>
<param name="quality" value="high">
<param name="wmode" value="transparent">
<param name="bgcolor" value="#000000">
<embed name="logo" src="city34.swf" menu="false" quality="high" wmode="transparent" bgcolor="#000000" width="540" height="210" type="application/x-shockwave-flash" >
</embed>
</object> </center>{strip}
{if $Action == ""}
        {$Pollsinfo}<br /><br />
