...
define('ACCEPT', 'Wieści/plotki/ankiety');
define('MODERATOR', 'Opcje moderatora');
define('GAME', 'Edycja elementów gry');
define('PLAYERS', 'Operacje na graczach');
define('BAN', 'Banowanie/kasowanie kont');
define('ADMINISTRATION', 'Opcje administracyjne');


if (!isset($_GET['view']))
{
    define('A_WELCOME', 'Witaj w panelu administracyjnym. Co chcesz zrobić?');
    define('A_REPUTATION', 'Przyznaj reputację');
    ...
    define('A_PLAYERQUEST', 'Dodaj gracza do zadania "Mroczny Mag"');
    ...
    define('A_CHANGE_NICK', 'Zmień graczowi imię lub profil');
}
...
if(isset($_GET['view']) && $_GET['view'] == 'addreps')
{
    ...
    define('T_AMOUNT', 'Ilość punktów');
    define('T_PLAYER_ID', 'ID');
    define('T_DESC', 'Rodzaj zasługi');
    define('T_ADDED', 'Reputacja została przyznana');
    define('RECEIVE', 'Otrzymałeś ');
    define('REPUTATION_POINTS', ' punktów reputacji za: ');
}
...
if (isset ($_GET['view']) && $_GET['view'] == 'add')
{
    ...
    define('RANK_TECH', 'Techniczny');
    define('R_FFFD', 'Idiota');
    define('R_GGG', 'Hamm I');
    define('R_FDF', 'Łowca Potworów');
    define('R_TFRN', 'Techniczny');
    define('R_JGU', 'Skórwiel');
    define('R_KSIADZ', 'Ksiądz');
    define('R_MAGAZYNIER', 'Magazynier');
    define('R_STRAZNIK', 'Strażnik Miejski');
    define('R_MURGRABIA', 'Murgrabia');
    define('R_DRUID', 'Druid');
    define('R_KROLOWAPOTEPIONYCH', 'Królowa Potępionych');
    define('R_HONOROWYMIESZKANIEC', 'Honorowy Mieszkaniec');
    define('R_WIELKIMISTRZ', 'Wielki Mistrz');
    define('R_GLADIATOR', 'Gladiator');
    define('R_STARYDZIAD', 'Stary Dziad');
      define('R_WSKRZESICIEL', 'Wskrzesiciel');
        define('R_KOSTUCH', 'Kostuch');
        define('R_MISTRZGRY', 'Mistrz Gry');
    define('R_ZUL', 'Żul spod mostu');
...
{
    define('YOU_SEND_M', 'Przekazałeś zasoby!');
    define('DONATE_ID', 'ID');
    define('AMOUNT', 'Ilość');
    define('A_DONATE', 'Dotuj');

	//TODO:zrobić z tym burdelem porządek, tak żeby się nie dublowały stałe
	define ('CREDITS', 'złoto');
	define ('PINE', 'sosna');
	define ('HAZEL', 'leszczyna');
	define ('COPPER', 'sztabki miedzi');
	define ('COPPERORE', 'ruda miedzi');
	define ('PLATINUM', MITHRIL);
	define ('COAL', 'węgiel');
	define ('IRON', 'żelazo');
	define ('IRONORE', 'ruda żelaza');
	define ('ZINCORE', 'ruda cynku');
	define ('TINORE', 'ruda cyny');
	define ('STEEL', 'stal');
	define ('BRONZE', 'brąz');
	define ('YEW', 'cis');
	define ('ELM', 'wiąz');
	define ('BRASS', 'sztabki mosiądzu');
	define ('CRYSTAL', 'kryształ');
	define ('ADAMANTIUM', 'adamantium');
	define ('METEOR', 'meteor');
}
