...
if (isset($_GET['battle']) || (isset ($_GET['action']) && $_GET['action'] == 'monster') || 1) 
{
    ...
    define('YOUR_CLAN', 'Nie atakuj członków swojej gildii!');
    ...
    define('TOO_LOW', 'Nie możesz zaatakować gracza na takim niskim poziomie. Możesz atakować graczy z maksymalnie mniejszym poziomem od Twojego o 30%!');
    ...
    define('ORAZ', 'oraz');
    define('LOST_FIGHT_MON', 'Przegrana (Uderzony potężnym ciosem upadasz z hukiem na ziemię i nic już nie pamiętasz...)');
...
{
    define('BATTLE_INFO', '<p>Idziesz sobie alejką pod górę i nagle widzisz tłumy magów, wojowników a nawet 
obywateli podążających do pewnego budynku. Gdy zbliżyłeś się do niego, 
zauważyłeś, że jest on wykonany z mocnego kamienia w kolorze jasnoszarym, w 
niektórych miejscach pozłacanym. Na górze owego budynku znajdują się trzy wieże. 
Każda z nich jest pokryta innym materiałem: pierwsza brązem, druga srebrem, i w 
końcu trzecia złotem. Przy wejściu do budynku jest wyryty w ścianie napis Arena 
Walk. Wchodzisz do środka gdzie widzisz tłumy wojowników. Ściany są zrobione z 
twardego kamienia, w częściach pozłacanego. Ciekawy wbiegasz do największej z 
sal gdzie wszystko jest pokryte kamieniem i gdzie znajdują się drzwi. 
Podekscytowany chciałeś owe drzwi otworzyć, ale w tym momencie złapał Cię za 
dłoń silny wojownik i powiedział: <i>Witaj, czego tutaj szukasz?</i> Ty 
odpowiadasz:</p>
');
