...
if ($player -> corepass != 'Y') {
	...
	if ($_GET['view'] == 'my') {
		...
		define('MARKET_INFO','Witaj w sklepie z chowańcami. Tutaj możesz sprzedać innym graczą swojego chowańca, bądź sam możesz go kupić od innych graczy.');
		define('A_BUY','Kup');
		define('C_ATTACK','Atak');
		define('C_DEFENCE','Obrona');
		define('C_SPEED','Szybkość');
		...
		define('ARENA_INFO','Witaj na arenie chowańców.');
