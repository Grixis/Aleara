...
if (!isset($_GET['step'])) {
	define('MENU_INFO', '<p>Kiedy przeszedłeś przez wielki wykuty w skale portal tylko zdążyłeś spostrzec 
napis na nim. Naur Lach a Gond. Dalej niesiony falą tłumu znalazłeś się przy 
rozszerzeniu groty. <br />
- A więc tak wyglądają te legendarne huty krasnoludów... - pomyślałeś, widząc, 
jak korytarz się rozszerza, a przy ścianach ciągną się po podziemny horyzont 
ogromne piece.<br />
Nagle zaczepił Cię jakiś krasnolud szukający nowej klienteli.<br />
- Nie widziałeś mojego pieca? Żałuj, takiego żaru nie znajdziesz w całym 
Królestwie!<br />
Jakiś inny krasnolud poprawił go złośliwie, nim Ty zdążyłeś wyrazić dezaprobatę:<br />
- Nikt jednak nie przebije starego Nad&#39;dehala. Jego huta dziennie wyrabiała 
miliony sztabek. <br />
A widząc twoją zdziwioną minę dodał:<br />
- Spróbuj mu dorównać! Wielkie piece stoją do Twojej dyspozycji. Możesz wykupić 
jeden z nich, a w razie potrzeby powiększyć! Ale najpierw idź do siedziby cechu, 
tam, koło publicznego pieca i zgłoś się do zarządcy. Tylko przejdź tym skrótem. 
Ominiesz tłumy - to mówiąc mrugnął okiem i wyszczerzył zęby zza włochatej, 
sięgającej mu do pasa brody. <br />
<br />
Chwilę później stoisz przed ogromnym piecem, żar bijący od niego sprawia, że na 
Twej twarzy zaczynają pojawiać się rumieńce, a na czole krople potu. W środku 
słychać jak coś powoli bulgocze. Ciecz wypływająca z pieca kierowana jest prosto 
do wielu stanowisk, przy których żmudnie pracują krasnoludy, gnomy i jeden elf.<br />
Podszedł do Ciebie krasnolud, któremu z wyglądu do zarządcy było daleko.<br />
- Może kupisz własną hutę? Jeśli chcesz przetopić lub wzmocnić ekwipunek, 
skorzystaj z tego publicznego pieca.<br />
<br />
Co chcesz zrobić?</p>
');
