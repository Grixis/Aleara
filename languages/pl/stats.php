...
define('T_ZYWIOL', 'żYWIOŁ');
define('T_STAN', 'sTAN cYWILNY');
define('T_OCZY', 'Oczy');
define('T_WLOSY', 'Włosy');
define('T_CHARAKTER', 'Charakter');
define('T_SKORA', 'Skóra');
define('T_WZROST', 'Wzrost');
define('T_UBIUR', 'Ubiór');
define('T_ZAMILOWANIE', 'Zamiłowanie');
define('T_POMAGAM', 'Chęć pomocy');
