...
define('YOU_MEET', 'Umarlak okazuje wrogość');
define('A_EXPLORE', 'Szukaj zmarłych do wskrzeszenia');

if (isset($_GET['step']) && $_GET['step'] == 'run')
{
    define('ESCAPE_SUCC', 'Udało ci się uciec przed wskrzeszonym przez innego Nekromanty');
...
{
    define('MAZE_INFO','Przechodząc przez starą bramę cmentarza w Noc Trupów, dostrzegasz w poblirzu parę zmarłych. Idziesz dalej?');
}
    else
{
    ...
    define('EMPTY_1', 'Zmarły jesk zabardzo posiekany... nic z nim nie zrobisz...');
    define('EMPTY_2', 'Zmarły podlega hipnizie innego Nekromanty');
    define('EMPTY_3', 'Zmarły uciekł Ci');
    define('EMPTY_4', 'Chyba nie chcesz ożywić kożenia drzewa?');
    define('EMPTY_5', 'Nie udało Ci się puścić czaru');
