...
{
    define('T_TOPIC', 'Przygoda');
    define('T_AUTHOR', 'Organizator');
    define('T_REPLIES', 'Wypowiedzi');
    define('ADD_TOPIC', 'Rozpocznij Nową Przygodę');
    define('T_TEXT', 'Tekst');
    define('TO_CATEGORIES', '');
...
if (isset($_GET['topic']))
{
	...
	define ('TO_TOPICS', 'do listy przygód');
    define('TO_CATEGORIES', '');
}

if (isset ($_GET['action']) && $_GET['action'] == 'addtopic')
{
    define('TOPIC_ADD', 'Przygoda dodana. Kliknij');
    define('TO_BACK', 'tutaj</a> aby wrócić do listy przygód.');
...
if (isset($_GET['reply']))
{
    ...
    define('A_HERE', 'tutaj');
    define('RETURN1', 'by wrócić do przygody');
    define('RETURN2', 'by wrócić do listy przygód.');
}
...
{
    define('NO_SEARCH', 'Nie ma takiego słowa!');
    define('YOU_FIND', 'Oto lista przygód w których znajduje się szukane słowo');
}
?>
