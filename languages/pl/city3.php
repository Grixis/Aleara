...
if ($player -> location == 'Ardulith') {
	$arrTitles = array('');
	$arrNames = array(array('<center>Stare Bagnisko</center>', '<center>Zaginiony Dwór</center>', '<center>Tablica Wskrzesicieli Krutynów</center>', '<center>Brama Puszczy Krutynów</center>'),
	array(),
	array(),
	array(),
	array(),
	...
	define('CITY_INFO', '<p>Wędrując po ziemiach Huritinu dostrzegłeś na horyzoncie mury wielkiego, potężnego i bogatego miasta. Podchodzisz bliżej. Przed Tobą znajduje się tabliczka z napisem „Aleara”. Widzisz olbrzymią bramę. Chcesz przez nią przejść, lecz zatrzymują Cię strażnicy miejscy. Po krótkim wywiadzie masz pozwolenie przejścia przez bramę. Niezwłocznie wchodzisz do miasta i widzisz przed sobą niezwykle piękną i bogatą metropolię. Idąc uliczkami Aleary dochodzisz do centrum miasta… Zastanawiasz się czy chcesz tutaj zostać, <b><a href="travel.php?action=city2">czy ruszyć w podróż na ziemie Kurysium do Krwawe Mokradła...</a></b></p>');
