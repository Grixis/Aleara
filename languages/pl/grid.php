...
{
    define("LAB_INFO", "				<p>Schodzisz w dół drabinką do miejskich kanałów. W 
				zamierzchłych czasach system ten rozbudowali Ojcowie Kraina 
				Mroku - Aleara. Nikt do końca nie wie czemu służył ten wielki, 
				rozbudowany labirynt korytarzy, ciągnący się pod ziemią daleko 
				poza granice miasta. Dziś jednak podziemny system wykorzystywany 
				jest jako doskonały system kanalizacyjny mający kilkanaście 
				pięter i poziomów. Jednak rozmiary i przestronność tej 
				starożytnej budowli stały się także schronieniem dla rzeszy 
				ulicznych żebraków, rzezimieszków i innego hultajstwa, 
				poszukującego skarbów oraz cennych pozostałości z dawnych lat 
				świetności Arear. Ponadto czym dalej w głąb tym coraz 
				niebezpieczniej – można natknąć się na grupę goblinów, koboldów, 
				orków lub nawet na potężniejsze potwory. Czy jesteś pewien, że 
				chcesz podążać w nieznane? </p>
");
}
?>
