...
define('SMITH_INFO', '- Żwawo! Przecież wiecie, że nie mamy czasu! - Wielki gnom, uznawany przez wszystkich za Wielkiego Mistrza w swoim zawodzie, podszedł z hucznym tupotem stóp do znajdujących się obok niego drzwi. Otworzył je głośno z trzaskiem i wszedł do sali. Stanął na jej środku. Jedną rękę położył na swoim brzuchu, a drugą pogładził brodę. Spojrzał złośliwym, choć trochę leniwym wzrokiem po obecnych towarzyszach.
<br><br>
Sala była dużych rozmiarów. Mieściła kilkanaście piecy do wyrobu różnych broni, jak i pozostałego ekwipunku dla każdego dzielnego wojownika. Panowała tam ciemność i czuć było spalenizną i wytapianymi metalami. Niedaleko kuźni stał wybudowany magazyn, gdzie rzemieślnicy przechowywali swoje wyroby, eksportowane później do innych miast.
<br><br>
- Ale... O Mistrzu... - Krasnolud podbiegł do gnoma i z trudem zaczął mówić. W końcu w owej sali panował okropny hałas... Spojrzał na swojego mistrza i kontynuował swoją mowę.
<br>- Dzisiejszego dnia do kuźni przybyło kilku nowych rzemieślników. Ich liczba stale rośnie. W takim tempie w ciągu kilku miesięcy będziemy zmuszeni wybudować kolejne skrzydło budynku, które będzie służyć do prac. I dzisiaj zamówiliśmy ogromną liczbę sztabek i brył węgla... Ciekawe czy hutnicy sprostają wymaganiom...');
if (!isset($_GET['kowal']))
{
