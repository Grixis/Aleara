...
define('T_DEITY', 'Żywioł');
define('T_DEITY', 'Stan Cywilny');
define('T_DEITY', 'Oczy');
define('T_DEITY', 'Włosy');
define('T_DEITY', 'Charakter');
define('T_DEITY', 'Skóra');
define('T_DEITY', 'Wzrost');
define('T_DEITY', 'Ubiór');
define('T_DEITY', 'Zamiłownie');
define('T_DEITY', 'Chęć Pomagania');
define('S_LIVE', 'Żywy');
...
if (isset ($_GET['steal']))
{
    ...
    define('VERDICT', 'Próba okradzenia mieszkańca Aleary');
...
if (isset ($_GET['steal_bank']))
{
    ...
    define('YOU_IMMU', 'Nie możesz okradać innych graczy ponieważ posiadasz immunitet');
    define('HE_IMMU', 'Nie możesz okradać gracza, który posiada immunitet');
    define('VERDICT', 'Próba napadu na skarbiec mieszkańca Aleary');
    define('YOU_IN_JAIL', 'Zostałeś wtrącony do więzienia na 3 dni za próbę napadu na skarbiec gracza. Możesz wyjść z więzienia za kaucją: ');
    define('YOU_CATCH', 'Pod twoją nieobecność ktoś próbował ograbić twój skarbiec. To ');
    define('L_ID', '</a></b>, ID <b>');
    define('YOU_CATCH2', '</b>. Na szczęście strażnicy złapali złodzieja.');
    define('YOU_JAILED', 'Po unieszkodliwieniu zamka w drzwiach skarbca wtargnąłeś do środka i zacząłeś zbierać łupy. Po chwili ktoś zamknął i zaryglował drzwi za tobą. Po niedługim czasie skarbiec otworzyli strażnicy i wtrącili do lochu.');
    define('WHEN_YOU', 'Kiedy siedziałeś sobie spokojnie w celi poczułeś nagle, że Twój współokator grzebie Ci przy sakiewce. To ');
    define('YOU_TRY_IN', 'Próbowałeś okraść współwięźnia ale niestety nie udało Ci się');
    define('NOT_CATCH', '</b>! Próbowałeś go złapać, niestety wyrwał Ci się wraz z Twoimi ');
    define('GOLD_COINS', ' sztukami złota.');
    ...
    define('EMPTY_BAG', '</b>! Próbowałeś go złapać, niestety wyrwał Ci się. Ciekawe czy mocno się zdziwi kiedy zauważy, że nie miałeś w sakiewce ani grosza.');
    define('EMPTY_BAG2', 'Kiedy sięgałeś do sakiewki mieszkańca, ten zauważył Twój ruch. Szybko złapał Cię za nadgarstek, na szczęście zdążyłeś się wyswobodzić i uciec. Kiedy zajrzałeś do sakiewki, omal krew Cię nie zalała - tyle kłopotów z powodu pustej sakiewki!');
    define('YOU_CRIME', 'Kiedy przechodziłeś obok swojego skarbca, zobaczyłeś rozwalony zamek. Sprawdziłeś zawartość - brakuje ');
    define('YOU_CRIME2', ' sztuk złota. Ktoś się włamał !');
    define('SUCCESS', 'Udało ci się niepostrzenie wśliznąć do skarbca i nieco go odchudzić. Twój zarobek - to ');
    define('EMPTY_BAG3', 'Kiedy przechodziłeś obok twojego skarbca, zobaczyłeś rozwalony zamek. Na szczęście nic w nim nie miałeś - tym razem miałeś szczęście.');
    define('EMPTY_BAG4', 'Po unieszkodliwieniu zamka w drzwiach skarbca wtargnąłeś do środka, jednak ten świecił pustkami. To nie jest twój szczęśliwy dzień....');
    define('TOO_YOUNG', 'Nie możesz okradać mieszkańców z wiekiem niższym niż 3 dni.');
    define('R_INT', 'inteligencji');
    define('R_AGI', 'zręczności');
}
