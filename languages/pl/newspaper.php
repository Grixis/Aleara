...
define('NO_PAPER', 'Nie ma jeszcze opublikowanych numerów gazety. (<a href="newspaper.php">Wróć</a>)<br /><br />');
define('A_BACK', 'Wróć');
...
if (!isset($_GET['comments']) && !isset($_GET['step']) && !isset($_GET['read']))
{
    ...
    define('A_ARCHIVE', 'Archiwum Gazetki aleariańskiej');
    define('A_REDACTION', 'Redakcja Gazetki aleariańskiej');
    define('A_RED_MAIL', 'Skrzynka pocztowa');
}

if (isset($_GET['step']) && $_GET['step'] == 'archive')
{
    define('ARCHIVEINFO', 'Oto lista numerów archiwalnych Gazetki aleariańskiej');
...
if (isset($_GET['step']) && $_GET['step'] == 'redaction')
{
    ...
    define('NEWSPAPER_RELEASED', 'Opublikowałeś najnowszy  Gazetki aleariańskiej');
