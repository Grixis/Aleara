...
{
    define("PORTAL_TEXT", "Udało Ci się wywołać Diaburiona z zaświatów. Co robisz?");
...
if (isset ($_GET['action1']) && $_GET['action1'] == 'fight') 
{
    ...
    define("PORTAL_TEXT", "Zwycięztwo.. Udało ci się pokonać Diaburiona");
    define("SWORD", "item1");
    define("ARMOR", "item2");
