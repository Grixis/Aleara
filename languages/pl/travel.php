...
{
    define('STABLES_INFO', '');
    define('A_FOREST', 'Las Zbłąkanych Dusz');
    define('A_ELFCITY', $city2);
    define('A_MOUNTAINS', 'Góry Przeznaczenia');
...
if (isset($_GET['action']))
{
	...
	define('MNT_FREE', 'Podróż w Góry Przeznacznia z Krwawych Mokradeł jest darmowa. Kliknij <a href="city.php?step=gory">tutaj</a>, aby tam dotrzeć.');
	define('CITY_FREE', 'Podróż na Krwawe mokradła z Gór Przeznaczenia jest darmowa. Kliknij <a href="gory.php?action2=city">tutaj</a>, aby tam dotrzeć.');
...
if (isset ($_GET['akcja']))
{
    ...
    {
        case 'gory':
            define('YOU_REACH', ' Dotarłeś do Gór Przeznaczenia. Wejdź <a href=gory.php>tutaj</a>, aby zobaczyć co Ciebie czeka.');
            break;
        case 'las':
            define('YOU_REACH', ' Dotarłeś do Lasu Zbłąkanych Dusz. Wejdź <a href=las.php>tutaj</a>, aby zobaczyć co Ciebie czeka.');
            break;
        case 'city2':
