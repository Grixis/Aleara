...
if (isset($title) && !isset($title1))
{
    $arrTitle = array('Opcje konta', 'Dodaj Plotkę', 'Dodaj Wieść', 'Apteka', 'Pracownia alchemiczna',
                      ...
                      'Spis książąt', 'Jubiler', 'Rynek jubilerski', 'Kopalnia', 'Kopalnie', 'Huta', 'Astralny plan', 'Warsztat jubilerski',
                      'Historia walk', 'Ranking Graczy', 'Krasnoludzki Bank', 'Reputacja', 'Statystyki ogólne krainy', 'Schronisko',
                      'Stary Pub', 'Stajnia Koni', 'Ranking Gildii', 'Ogród', 'Opuszczona Kuźnia', 'Opuszczone Stawy', 'Zagajnik Szamanów',
                      'Pole ziemniaków','Chatka Leśniczego','Dom Cechowy','Tawerna','Arena Honorowa','Kuchnia',
                      'Loteria','Cmentarz','Wieża Druida','Hala Gladiatorów','Wieża Obserwacyjna','Giełda',
                      'Małżeństwa','Gildia Złodzieji','Sklepy mieszkańców','Baszta Najemników',
                      'Sklep z brylantami','Dom pokus', 'Czat', 'Gildia', 'Lekarz klanu', 'Leże Nughorga', 'Przegląda profil gracza', 'Przeklęta Jaskinia'
