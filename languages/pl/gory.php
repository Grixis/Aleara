...
define('A_HERE', 'tutaj');
define('MOUNT_INFO', '<p>Spoglądasz przed siebie i widzisz starą kopalnię, oraz ścieżkę prowadzącą w nieznane.. Zastanawiasz się chwilę co masz robić.</p>');
