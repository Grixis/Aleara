...
define('BACK', 'Wróć');
define('TEAM', 'Team');
define('UNFINISHED', 'Twoja postać jest niedokończona. Do właściwego grania w naszym świecie musisz mieć wybraną <i>płeć</i>, <i>rasę</i> i <i>klasę</i>, inaczej większość z lokacji dostępnych w <i>Alearze</i> będzie niedostępnych.<p>&raquo; <a href="card.php">Przejdź do kreatora postaci</a></p><br>');
define('RET_SELF', 0);
define('RET_SELF', 1);
