...
$smarty -> assign ( array("Houseid" => $house -> fields['id']));
...
{
	error ('Jako, że jesteś w lochu - nie mo�esz tutaj przebywać.');
}
/**
...
{
    error ('<center><IMG SRC="images/locations/bramymiasta.png"></center>
<img style="margin-left: -8px" width="538px"  src="liniuszka.png"><br><br>Nie możesz opuścić miasta bez zapłaty strażnikom za pobyt tutaj!<a href="diabolium.php"> (Wróć do miasta)</a>');
}
if ($player -> hp == 0)
{
    error (YOU_DEAD);
...
if ($_GET['action'] != '')
{
	switch ($player -> location)
	{
	  ...
	  error ('<center><IMG SRC="images/locations/bramymiasta.png"></center>
<img style="margin-left: -8px" width="538px"  src="liniuszka.png"><br><br>Dotarłeś na miejsce. <a href="gory.php">Wejdź...</a>');
			}
			break;
		case L_FOREST:
			if ($_GET['action'] == 'las')
		...
		case L_MOUNTAINS:
			...
			if ($_GET['action'] == 'city2')
			{
				$db -> Execute("UPDATE `players` SET `miejsce`='Ardulith' WHERE `id`=".$player -> id);
				 error ('<center><IMG SRC="images/locations/bramymiasta.png"></center>
<img style="margin-left: -8px" width="538px"  src="liniuszka.png"><br><br>Dotarłeś na miejsce. <a href="city.php">Wejdź...</a>');
			}
			break;
	}
...
*/
        case 'gory':
            ...
            {
                if ($player->credits < $arrGoldCosts['teleport']) error("Nie masz tyle złota");
