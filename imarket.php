...
if (isset ($_GET['view']) && $_GET['view'] == 'add') 
{
	if (isset ($_GET['step']) && $_GET['step'] == 'add') 
    {
        ...
        $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, status, szyb, twohand, ptype, repair, wzmocnienie, ulepszeniee) VALUES(".$player -> id.",'".$item -> fields['name']."',".$item -> fields['power'].",'".$item -> fields['type']."',".uint32($_POST['cost']).",".$item -> fields['zr'].",".$item -> fields['wt'].",".$item -> fields['minlev'].",".$item -> fields['maxwt'].",".$_POST['amount'].",'".$item -> fields['magic']."',".$item -> fields['poison'].",'R',".$item -> fields['szyb'].",'".$item -> fields['twohand']."','".$item -> fields['ptype']."', ".$item -> fields['repair'].",'".$item->fields['wzmocnienie']."',".$item->fields['ulepszeniee'].")");
...
if (isset ($_GET['view']) && $_GET['view'] == 'del') 
{
    ...
    while (!$objArm -> EOF)
    {
        ...
        {
            $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand, ptype, repair, wzmocnienie, ulepszeniee) VALUES(".$player -> id.",'".$objArm -> fields['name']."',".$objArm -> fields['power'].",'".$objArm -> fields['type']."',1,".$objArm -> fields['zr'].",".$objArm -> fields['wt'].",".$objArm -> fields['minlev'].",".$objArm -> fields['maxwt'].",".$objArm -> fields['amount'].",'".$objArm -> fields['magic']."',".$objArm -> fields['poison'].",".$objArm -> fields['szyb'].",'".$objArm -> fields['twohand']."','".$objArm -> fields['ptype']."', ".$objArm -> fields['repair'].",'".$objArm->fields['wzmocnienie']."', ".$objArm->fields['ulepszeniee'].")");
        } 
            else 
        {
...
if (isset($_GET['buy'])) 
{
    ...
    if (isset($_GET['step']) && $_GET['step'] == 'buy') 
    {
        ...
        if (!$test -> fields['id']) 
        {
            $db -> Execute("INSERT INTO equipment (owner, name, power, type, cost, zr, wt, minlev, maxwt, amount, magic, poison, szyb, twohand, ptype, repair, wzmocnienie, ulepszeniee) VALUES(".$player -> id.",'".$buy -> fields['name']."',".$buy -> fields['power'].",'".$buy -> fields['type']."',1,".$buy -> fields['zr'].",".$buy -> fields['wt'].",".$buy -> fields['minlev'].",".$buy -> fields['maxwt'].",".$_POST['amount'].",'".$buy -> fields['magic']."',".$buy -> fields['poison'].",".$buy -> fields['szyb'].",'".$buy -> fields['twohand']."','".$buy -> fields['ptype']."', ".$buy -> fields['repair'].",'".$buy->fields['wzmocnienie']."', ".$buy->fields['ulepszeniee'].")");
        } 
            else 
        {
        ...
        $smarty -> assign("Message", YOU_BUY.$_POST['amount'].I_AMOUNT.$buy -> fields['name']. ' za '.$price. ' sztuk złota. ');
    }
}
