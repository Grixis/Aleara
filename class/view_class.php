...
*/
    ...
    {
        global $db;
        $stats = $db -> Execute('SELECT `id`, `user`, `level`, `lang`, `seclang`, `avatar`, `gg`, `rank`, bank, szyb, `gender`, `immu`, `age`, `rasa`, `klasa`, `hp`, `max_hp`, `wins`, `losses`, `lastkilled`, `lastkilledby`, `profile`, `deity`, `tribe`, `tribe_rank`, `refs`, `page`, `credits`, `miejsce`, `ip`, `lpv` FROM `players` WHERE `id`='.$pid);
