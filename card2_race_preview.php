...
Człowiek otrzymuje za 1 AP:<br>
      ...
      +2.5 Inteligencji<br>
      +2.5 Siły Woli</p></p></p>
	<form method="post" action="card2.php?action=race&amp;select=human&amp;step=mark">
...
Elf otrzymuje za 1 AP:<br>
	...
	<form method="post" action="card2.php?action=race&amp;select=elf&amp;step=mark">
			<input type="submit" value="Wybierz" />
		</form> 
		');
}
...
Hobbit otrzymuje za 1 AP:<br>
      ...
      +3.4 Siły Woli<br>
  <br>
	<form method="post" action="card2.php?action=race&amp;select=hobbit&amp;step=mark">
			<input type="submit" value="Wybierz" />
		</form> 
	');
}
...
Jaszczuroczłek otrzymuje za 1 AP:<br>
      ...
      +2.3 Siły Woli<br>
      <br>
	<form method="post" action="card2.php?action=race&amp;select=reptilion&amp;step=mark">
			<input type="submit" value="Wybierz" />
		</form> 
');
}
...
Gnom otrzymuje za 1 AP:<br>
	...
	<form method="post" action="card2.php?action=race&amp;select=gnome&amp;step=mark">
			<input type="submit" value="Wybierz" />
		</form> 
');
}
...
Mroczny Elf otrzymuje za 1 AP:<br>
      ...
      +2.7 Siły Woli<br>
     <br>
	<form method="post" action="card2.php?action=race&amp;select=darkelf&amp;step=mark">
			<input type="submit" value="Wybierz" />
		</form> 
');
}
...
Nieumarły otrzymuje za 1 AP:<br>
      ...
      +3.5 Inteligencji<br>
      +3.6 Siły Woli<br><br>
	<form method="post" action="card2.php?action=race&amp;select=undead&amp;step=mark">
			<input type="submit" value="Wybierz" />
		</form> 
');
}
...
Tauren otrzymuje za 1 AP:<br>
      ...
      +2.7 Siły Woli<br>
      <br>
	<form method="post" action="card2.php?action=race&amp;select=tauren&amp;step=mark">
			<input type="submit" value="Wybierz" />
		</form>
');
}
...
Ork otrzymuje za 1 AP:<br>
      ...
      +2.7 Siły Woli<br>
      <br>
	<form method="post" action="card2.php?action=race&amp;select=ork&amp;step=mark">
			<input type="submit" value="Wybierz" />
		</form> 
');
}
