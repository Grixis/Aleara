...
{
	error ('<center><a href=travel.php>Wejdź i wybierz lokację</a></center>');
}
...
function city()
{
	...
	if ($player -> location == 'Ardulith')
	{
		...
		$arrFiles = array(array('bagnisko.php', 'dwor.php', 'puszcza.php'));
	}
...
if ($player -> location == 'Altara')
{
	...
	} elseif (isset($_GET['del']))
	{
	  ...
	  error ('Dotarłeś na miejsce. <a href="gory.php">Wejdź...</a>');
	}
}
